...
import com.ubiqube.etsi.mano.v271.model.em.vnflcm.VnfLcmOpOccResourceChanges;
import com.ubiqube.etsi.mano.v271.model.vnfm.vnflcm.VimConnectionInfo;

import jakarta.annotation.Nullable;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface VnfLcmOpOcc271Mapping extends StringToUriMapping, Connectivity271Mapping, VimConnectionInfo271Mapping, VimResource271Mapping {
...
//	@Mapping(target = "parameters", source = "operationParams")
	...
	@Mapping(target = "startTime", ignore = true)
	@Mapping(target = "status", ignore = true)
	@Mapping(target = "toscaName", source = "vnfVirtualLinkDescId")
	@Mapping(target = "vduId", ignore = true)
