...
import com.ubiqube.etsi.mano.v271.model.em.vnflcm.CpProtocolInfo;
import com.ubiqube.etsi.mano.v271.model.em.vnflcm.IpOverEthernetAddressInfoIpAddresses;
...
import com.ubiqube.etsi.mano.v271.model.em.vnflcm.VnfInstanceInstantiatedVnfInfo;
import com.ubiqube.etsi.mano.v271.model.em.vnflcm.VnfcResourceInfo;
import com.ubiqube.etsi.mano.v271.model.sol005.nslcm.NsInstance;
import com.ubiqube.etsi.mano.v271.model.sol005.nslcm.NsVirtualLinkInfo;
import com.ubiqube.etsi.mano.v271.model.sol005.nslcm.VnffgInfo;

import jakarta.annotation.Nullable;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface NsInstance271Mapping extends VimResource271Mapping {
	...
	com.ubiqube.etsi.mano.v271.model.sol005.nslcm.NsScaleInfo map(com.ubiqube.etsi.mano.dao.mano.ScaleInfo o);
	...
	@Nullable
	default com.ubiqube.etsi.mano.v271.model.sol005.nslcm.NsCpHandle mapSetDb(final @Nullable Set<NsCpHandle> value) {
	...
	com.ubiqube.etsi.mano.v271.model.sol005.nslcm.NsCpHandle map(@Nullable NsCpHandle value);
	...
	@Mapping(target = "scaleLevel", ignore = true)
	@Mapping(target = "vnfdId", ignore = true)
	com.ubiqube.etsi.mano.dao.mano.ScaleInfo map(com.ubiqube.etsi.mano.v271.model.sol005.nslcm.NsScaleInfo o);
	...
	com.ubiqube.etsi.mano.dao.mano.VnfMonitoringParameter map(com.ubiqube.etsi.mano.v271.model.em.vnflcm.MonitoringParameter o);
	...
	@Mapping(target = "vnfdId", ignore = true)
	@Mapping(target = "audit", ignore = true)
	VnfMonitoringParameter map(com.ubiqube.etsi.mano.v271.model.sol005.nslcm.VnfMonitoringParameter o);
	...
	@Nullable
	default Set<NsCpHandle> mapSet(final @Nullable com.ubiqube.etsi.mano.v271.model.sol005.nslcm.NsCpHandle value) {
		if (null == value) {
			return Set.of();
		}
	...
	@Mapping(target = "id", ignore = true)
	NsCpHandle map(com.ubiqube.etsi.mano.v271.model.sol005.nslcm.NsCpHandle o);
