...
import com.ubiqube.etsi.mano.v271.model.vnfind.VnfIndicatorValueChangeNotification;

import jakarta.validation.Valid;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface PmJobNotification271Mapping extends DateTimeMapping {
	...
	ThresholdCrossedNotification map(com.ubiqube.etsi.mano.v271.model.vnfpm.@Valid ThresholdCrossedNotification body);
