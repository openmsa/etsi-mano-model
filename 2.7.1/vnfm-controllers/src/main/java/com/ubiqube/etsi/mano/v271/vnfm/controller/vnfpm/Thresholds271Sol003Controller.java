 ...
 */
package com.ubiqube.etsi.mano.v271.vnfm.controller.vnfpm;
...
import com.ubiqube.etsi.mano.v271.model.em.vnfind.CreateThresholdRequest;
import com.ubiqube.etsi.mano.v271.model.em.vnfind.Threshold;
import com.ubiqube.etsi.mano.v271.model.em.vnfind.ThresholdLinks;
import com.ubiqube.etsi.mano.v271.model.em.vnfind.ThresholdModifications;
...
public class Thresholds271Sol003Controller implements Thresholds271Sol003Api {
	...
	public Thresholds271Sol003Controller(final VnfmThresholdFrontController vnfmThresholdFrontController, final MapperFacade mapper) {
	...
	public ResponseEntity<Threshold> thresholdsPost(@Valid final CreateThresholdRequest createThresholdRequest) {
		...
		return vnfmThresholdFrontController.thresholdsCreate(req, x -> mapper.map(x, Threshold.class), Thresholds271Sol003Controller::makeLinks, Thresholds271Sol003Controller::getSelfLink);
	}
	...
	public ResponseEntity<Threshold> thresholdsThresholdIdGet(final String thresholdId) {
		return vnfmThresholdFrontController.findById(thresholdId, x -> mapper.map(x, Threshold.class), Thresholds271Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<String> thresholdsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return vnfmThresholdFrontController.search(requestParams, nextpageOpaqueMarker, x -> mapper.map(x, Threshold.class), Thresholds271Sol003Controller::makeLinks, Threshold.class);
	}
