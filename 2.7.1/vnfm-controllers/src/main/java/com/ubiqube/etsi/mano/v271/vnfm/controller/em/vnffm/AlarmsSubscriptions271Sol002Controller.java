 ...
 */
package com.ubiqube.etsi.mano.v271.vnfm.controller.em.vnffm;
...
public class AlarmsSubscriptions271Sol002Controller implements AlarmsSubscriptions271Sol002Api, SubscriptionLinkable271Vnfm {
	...
	public AlarmsSubscriptions271Sol002Controller(final FaultMngtSubscriptionsFrontController faultMngtSubscriptionsFrontController, final FmSubscription271Mapping mapper) {
	...
	public ResponseEntity<List<FmSubscription>> subscriptionsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return faultMngtSubscriptionsFrontController.search(requestParams, x -> mapper.map(x, FmNotificationsFilter.class), AlarmsSubscriptions271Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<FmSubscription> subscriptionsPost(@Valid final FmSubscriptionRequest body) {
		...
		return faultMngtSubscriptionsFrontController.create(req, x -> mapper.map(x, FmNotificationsFilter.class), AlarmsSubscriptions271Sol002Api.class, AlarmsSubscriptions271Sol002Controller::makeLinks, AlarmsSubscriptions271Sol002Controller::makeSelf);
	}
	...
	public ResponseEntity<FmSubscription> subscriptionsSubscriptionIdGet(final String subscriptionId) {
		return faultMngtSubscriptionsFrontController.findById(subscriptionId, x -> mapper.map(x, FmNotificationsFilter.class), AlarmsSubscriptions271Sol002Controller::makeLinks);
	}
	...
	public String makeSelfLink(final String id) {
		return linkTo(methodOn(AlarmsSubscriptions271Sol002Api.class).subscriptionsSubscriptionIdGet(id)).withSelfRel().getHref();
	}
