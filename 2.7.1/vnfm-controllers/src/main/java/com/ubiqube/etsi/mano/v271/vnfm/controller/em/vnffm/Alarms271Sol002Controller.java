...
import com.ubiqube.etsi.mano.v271.model.em.vnffm.AlarmLinks;
import com.ubiqube.etsi.mano.v271.model.em.vnffm.AlarmModifications;
import com.ubiqube.etsi.mano.v271.model.em.vnffm.PerceivedSeverityRequest;
...
public class Alarms271Sol002Controller implements Alarms271Sol002Api {
	...
	private final Alarm271Mapping mapper;

	public Alarms271Sol002Controller(final AlarmFrontController alarmFrontController, final Alarm271Mapping mapper) {
	...
	public ResponseEntity<Alarm> alarmsAlarmIdGet(final String alarmId) {
		return alarmFrontController.findById(alarmId, x -> mapper.map(x), Alarms271Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<String> alarmsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return alarmFrontController.search(requestParams, x -> mapper.map(x), Alarms271Sol002Controller::makeLinks, Alarm.class);
	}
