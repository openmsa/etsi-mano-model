...
public class Alarms271Sol003Controller implements Alarms271Sol003Api {
	...
	public Alarms271Sol003Controller(final AlarmFrontController alarmFrontController, final MapperFacade mapper) {
	...
	public ResponseEntity<Alarm> alarmsAlarmIdGet(final String alarmId) {
		return alarmFrontController.findById(alarmId, x -> mapper.map(x, Alarm.class), Alarms271Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<String> alarmsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return alarmFrontController.search(requestParams, x -> mapper.map(x, Alarm.class), Alarms271Sol003Controller::makeLinks, Alarm.class);
	}
