...
import com.ubiqube.etsi.mano.v261.model.nfvo.nslcm.NsLcmOpType;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface NsLcmOpOcc261Mapping extends StringToUriMapping {
	@Mapping(target = "statusEnteredTime", source = "stateEnteredTime")
	...
	@ValueMapping(source = "STARTED", target = "STARTING")
