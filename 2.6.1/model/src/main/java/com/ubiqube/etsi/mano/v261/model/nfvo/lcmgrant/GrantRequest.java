...
public class GrantRequest {
	 ...
	 **/
	@Schema(requiredMode = RequiredMode.REQUIRED, description = "Identifier of the VNF instance which this grant request is related to. Shall also be provided for VNFs that not yet exist but are planned to exist in the future, i.e. if the grant is requested for InstantiateVNF. ")
	@Nonnull
	 ...
	 **/
	@Schema(requiredMode = RequiredMode.REQUIRED, description = "The identifier of the VNF lifecycle management operation occurrence associated to the GrantRequest. ")
	@Nonnull
	 ...
	 * @return vnfdId
	 **/
	@Schema(requiredMode = RequiredMode.REQUIRED, description = "Identifier of the VNFD that defines the VNF for which the LCM operation is to be granted. ")
	@Nonnull
	 ...
	 * @return operation
	 **/
	@Schema(requiredMode = RequiredMode.REQUIRED, description = "The lifecycle management operation for which granting is requested. The VNF LCM operations CreateVnfIdentifier, DeleteVnfIdentifier, QueryVnf and ModifyVnfInformation can be executed by the VNFM without requesting granting. ")
	@Nonnull
