...
public interface Nsd261Mapping extends StringToUriMapping {

	@Mapping(target = "links", ignore = true)
	@Mapping(target = "pnfdInfoIds", source = "pnfdInfoIds")
	NsdInfo map(NsdPackage o);

	@ValueMapping(source = "ERROR", target = MappingConstants.THROW_EXCEPTION)
	NsdOnboardingStateType map(OnboardingStateType o);
