...
import com.ubiqube.etsi.mano.common.v261.model.nslcm.ExtLinkPortInfo;
...
import com.ubiqube.etsi.mano.common.v261.model.nslcm.IpOverEthernetAddressInfo;
...
public interface VnfInstance261Mapping extends VimConnectionInfo261Mapping, Connectivity261Mapping, VimResource261Mapping {
...
//	@Mapping(target = "id", ignore = true)
	VnfInstance map(com.ubiqube.etsi.mano.common.v261.model.nslcm.VnfInstance pkg);
	...
	com.ubiqube.etsi.mano.v261.model.vnfm.nslcm.ScaleInfo map(ScaleInfo o);
...
//	@Mapping(target = "scaleLevel", source = "scaleToLevel")
	...
	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "zoneId", ignore = true)
	VirtualStorageResourceInfo map(com.ubiqube.etsi.mano.common.v261.model.nslcm.VirtualStorageResourceInfo virtualStorageResourceInfo);

	com.ubiqube.etsi.mano.common.v261.model.nslcm.VirtualStorageResourceInfo map(VirtualStorageResourceInfo vsri);
