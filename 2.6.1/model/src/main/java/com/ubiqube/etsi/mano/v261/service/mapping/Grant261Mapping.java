...
import com.ubiqube.etsi.mano.common.v261.model.lcmgrant.GrantInfo;
...
public interface Grant261Mapping extends VimConnectionInfo261Mapping, Connectivity261Mapping, VimResource261Mapping {

	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "id", ignore = true)
	VimConstraint map(com.ubiqube.etsi.mano.v261.model.nfvo.lcmgrant.VimConstraint o);

	@Mapping(target = "vnfdId", ignore = true)
	@Mapping(target = "id", ignore = true)
	ScaleInfo map(com.ubiqube.etsi.mano.v261.model.vnfm.nslcm.ScaleInfo o);
	...
	@Mapping(target = "id", ignore = true)
	ConstraintResourceRef map(com.ubiqube.etsi.mano.v261.model.nfvo.lcmgrant.ConstraintResourceRef o);
	...
	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "id", ignore = true)
	PlacementConstraint map(com.ubiqube.etsi.mano.v261.model.nfvo.lcmgrant.PlacementConstraint o);
	...
	com.ubiqube.etsi.mano.v261.model.nfvo.lcmgrant.PlacementConstraint.ScopeEnum map(PlacementConstraint.ScopeEnum o);
