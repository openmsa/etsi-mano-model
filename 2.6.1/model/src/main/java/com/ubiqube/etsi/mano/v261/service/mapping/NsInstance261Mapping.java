...
import com.ubiqube.etsi.mano.common.v261.model.nslcm.VnfMonitoringParameter;
...
import com.ubiqube.etsi.mano.v261.model.nfvo.nslcm.NsVirtualLinkInfo;
import com.ubiqube.etsi.mano.v261.model.nfvo.nslcm.VnffgInfo;
import com.ubiqube.etsi.mano.v261.model.vnfm.nslcm.MonitoringParameter;
import com.ubiqube.etsi.mano.v261.model.vnfm.nslcm.ScaleInfo;

import jakarta.annotation.Nullable;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface NsInstance261Mapping extends VimResource261Mapping {
	...
	com.ubiqube.etsi.mano.v261.model.nfvo.nslcm.NsScaleInfo map(com.ubiqube.etsi.mano.dao.mano.ScaleInfo o);
	...
	@Nullable
	default com.ubiqube.etsi.mano.v261.model.nfvo.nslcm.NsCpHandle mapSetDb(final @Nullable Set<NsCpHandle> value) {
	...
	com.ubiqube.etsi.mano.v261.model.nfvo.nslcm.NsCpHandle map(@Nullable NsCpHandle value);
	...
	com.ubiqube.etsi.mano.dao.mano.VnfMonitoringParameter map(MonitoringParameter o);
	...
	@Mapping(target = "vnfdId", ignore = true)
	@Mapping(target = "audit", ignore = true)
	com.ubiqube.etsi.mano.dao.mano.VnfMonitoringParameter map(VnfMonitoringParameter o);
	...
	@Nullable
	default Set<NsCpHandle> mapSet(final @Nullable com.ubiqube.etsi.mano.v261.model.nfvo.nslcm.NsCpHandle value) {
		if (null == value) {
			return Set.of();
		}
	...
	@Mapping(target = "id", ignore = true)
	NsCpHandle map(com.ubiqube.etsi.mano.v261.model.nfvo.nslcm.NsCpHandle o);

	@Mapping(target = "vnfdId", ignore = true)
	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "zoneId", ignore = true)
	VirtualStorageResourceInfo map(com.ubiqube.etsi.mano.common.v261.model.nslcm.VirtualStorageResourceInfo p);
