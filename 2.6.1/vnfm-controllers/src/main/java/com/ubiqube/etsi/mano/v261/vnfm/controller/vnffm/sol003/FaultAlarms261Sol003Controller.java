...
import com.ubiqube.etsi.mano.v261.vnfm.faultmngt.Alarm;
import com.ubiqube.etsi.mano.v261.vnfm.faultmngt.AlarmLinks;
import com.ubiqube.etsi.mano.v261.vnfm.faultmngt.AlarmModifications;
...
public class FaultAlarms261Sol003Controller implements FaultAlarms261Sol003Api {
	...
	public FaultAlarms261Sol003Controller(final AlarmFrontController alarmFrontController, final MapperFacade mapper) {
	...
	public ResponseEntity<Alarm> alarmsAlarmIdGet(final String alarmId) {
		return alarmFrontController.findById(alarmId, x -> mapper.map(x, Alarm.class), FaultAlarms261Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<String> alarmsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return alarmFrontController.search(requestParams, x -> mapper.map(x, Alarm.class), FaultAlarms261Sol003Controller::makeLinks, Alarm.class);
	}
