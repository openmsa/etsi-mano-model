...
public class VnfInstance {
	 ...
	 * @return vnfdId
	 **/
	@Schema(requiredMode = RequiredMode.REQUIRED, description = "Identifier of the VNFD on which the VNF instance is based. ")
	@NotNull
	 ...
	 * @return vnfPkgId
	 **/
	@Schema(requiredMode = RequiredMode.REQUIRED, description = "Identifier of information held by the NFVO about the specific VNF package on which the VNF is based. This identifier has been allocated by the NFVO. This attribute can be modified with the PATCH method. ")
	@NotNull
	...
	public VnfInstance vimConnectionInfo(final List<VimConnectionInfo> vimId) {
		this.vimConnectionInfo = vimId;
		return this;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, vnfInstanceName, vnfInstanceDescription, vnfdId, vnfProvider, vnfProductName, vnfSoftwareVersion, vnfdVersion, vnfPkgId, vnfConfigurableProperties, vimConnectionInfo, instantiationState, instantiatedVnfInfo, metadata, extensions);
	}
