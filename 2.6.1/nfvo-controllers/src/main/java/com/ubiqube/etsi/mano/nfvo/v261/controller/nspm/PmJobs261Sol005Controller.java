...
public class PmJobs261Sol005Controller implements PmJobs261Sol005Api {
	...
	public ResponseEntity<String> pmJobsGet(final MultiValueMap<String, String> requestParams) {
		return nfvoPmController.search(requestParams, x -> mapper.map(x, com.ubiqube.etsi.mano.vnfm.v261.model.nsperfo.PmJob.class), PMJ_SEARCH_DEFAULT_EXCLUDE_FIELDS, PMJ_SEARCH_MANDATORY_FIELDS, PmJobs261Sol005Controller::makeLinks, com.ubiqube.etsi.mano.vnfm.v261.model.nsperfo.PmJob.class);
	}
