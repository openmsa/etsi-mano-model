 ...
 */
package com.ubiqube.etsi.mano.v281.vnfm.controller.em.vnfpm;
...
import com.ubiqube.etsi.mano.v281.model.em.vnfind.ThresholdLinks;
import com.ubiqube.etsi.mano.v281.model.em.vnfind.ThresholdModifications;
...
public class Thresholds281Sol002Controller implements Thresholds281Sol002Api {
	...
	public Thresholds281Sol002Controller(final VnfmThresholdFrontController vnfmThresholdFrontController, final MapperFacade mapper) {
	...
	public ResponseEntity<Threshold> thresholdsPost(@Valid final CreateThresholdRequest createThresholdRequest) {
		...
		return vnfmThresholdFrontController.thresholdsCreate(req, x -> mapper.map(x, Threshold.class), Thresholds281Sol002Controller::makeLinks, Thresholds281Sol002Controller::getSelfLink);
	}
	...
	public ResponseEntity<Threshold> thresholdsThresholdIdGet(final String thresholdId) {
		return vnfmThresholdFrontController.findById(thresholdId, x -> mapper.map(x, Threshold.class), Thresholds281Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<String> thresholdsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return vnfmThresholdFrontController.search(requestParams, nextpageOpaqueMarker, x -> mapper.map(x, Threshold.class), Thresholds281Sol002Controller::makeLinks, Threshold.class);
	}
