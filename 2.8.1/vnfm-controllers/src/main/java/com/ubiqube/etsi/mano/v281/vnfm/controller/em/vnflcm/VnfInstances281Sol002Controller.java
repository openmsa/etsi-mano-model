...
public class VnfInstances281Sol002Controller implements VnfInstances281Sol002Api {
	...
	public VnfInstances281Sol002Controller(final VnfInstanceGenericFrontController frontController, final VnfInstance281Mapping mapper, final VnfInstantiate281Mapping vnfInstantiate281Mapping, final VnfInstanceRequest281Mapping vnfInstanceRequest281Mapping) {
	...
	public ResponseEntity<String> vnfInstancesGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return frontController.search(requestParams, x -> mapper.map(x), nextpageOpaqueMarker, VnfInstances281Sol002Controller::makeLinks, VnfInstance.class);
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdChangeExtConnPost(final String vnfInstanceId, @Valid final ChangeExtVnfConnectivityRequest body) {
		...
		return frontController.changeExtConn(getSafeUUID(vnfInstanceId), req, VnfInstances281Sol002Controller::getLcmLink);
	}
	...
	public ResponseEntity<VnfInstance> vnfInstancesVnfInstanceIdGet(final String vnfInstanceId) {
		return frontController.findById(getSafeUUID(vnfInstanceId), x -> mapper.map(x), VnfInstances281Sol002Controller::makeLinks, "");
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdInstantiatePost(final String vnfInstanceId, @Valid final InstantiateVnfRequest body) {
		...
		return frontController.instantiate(getSafeUUID(vnfInstanceId), req, VnfInstances281Sol002Controller::getLcmLink);
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdOperatePost(final String vnfInstanceId, @Valid final OperateVnfRequest body) {
		...
		return frontController.operate(getSafeUUID(vnfInstanceId), req, VnfInstances281Sol002Controller::getLcmLink);
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdScalePost(final String vnfInstanceId, @Valid final ScaleVnfRequest body) {
		...
		return frontController.scale(getSafeUUID(vnfInstanceId), req, VnfInstances281Sol002Controller::getLcmLink);
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdScaleToLevelPost(final String vnfInstanceId, @Valid final ScaleVnfToLevelRequest body) {
		...
		return frontController.scaleToLevel(getSafeUUID(vnfInstanceId), req, VnfInstances281Sol002Controller::getLcmLink);
	}
