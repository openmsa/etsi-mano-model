...
import com.ubiqube.etsi.mano.v281.model.em.vnffm.AlarmModifications;
import com.ubiqube.etsi.mano.v281.model.em.vnffm.PerceivedSeverityRequest;
...
public class Alarms281Sol002Controller implements Alarms281Sol002Api {
	...
	private final Alarm281Mapping mapper;

	public Alarms281Sol002Controller(final AlarmFrontController alarmFrontController, final Alarm281Mapping mapper) {
	...
	public ResponseEntity<Alarm> alarmsAlarmIdGet(final String alarmId) {
		return alarmFrontController.findById(alarmId, x -> mapper.map(x), Alarms281Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<String> alarmsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return alarmFrontController.search(requestParams, x -> mapper.map(x), Alarms281Sol002Controller::makeLinks, Alarm.class);
	}
