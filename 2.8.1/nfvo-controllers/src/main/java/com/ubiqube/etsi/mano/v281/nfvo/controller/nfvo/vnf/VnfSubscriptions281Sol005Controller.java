 ...
 */
@RestController
public class VnfSubscriptions281Sol005Controller implements VnfSubscriptions281Sol005Api, SubscriptionLinkable281Nfvo {
	...
	public VnfSubscriptions281Sol005Controller(final VnfSubscriptionSol005FrontController vnfSubscriptionSol03FrontController, final PkgmSubscriptionRequest281Mapping mapper) {
	...
	public ResponseEntity<List<PkgmSubscription>> subscriptionsGet(final String filter) {
		return vnfSubscriptionSol03FrontController.search(filter, x -> mapper.map(x, PkgmNotificationsFilter.class), VnfSubscriptions281Sol005Controller::makeLinks);
	}
	...
	public ResponseEntity<PkgmSubscription> subscriptionsPost(final PkgmSubscriptionRequest body) {
		...
		return vnfSubscriptionSol03FrontController.create(req, VnfSubscriptions281Sol005Api.class, x -> mapper.map(x, PkgmNotificationsFilter.class), VnfSubscriptions281Sol005Controller::makeLinks);
	}
	...
	public ResponseEntity<PkgmSubscription> subscriptionsSubscriptionIdGet(final String subscriptionId) {
		return vnfSubscriptionSol03FrontController.findById(subscriptionId, x -> mapper.map(x, PkgmNotificationsFilter.class), VnfSubscriptions281Sol005Controller::makeLinks);
	}
	...
	public String makeSelfLink(final String id) {
		return linkTo(methodOn(VnfSubscriptions281Sol005Api.class).subscriptionsSubscriptionIdGet(id)).withSelfRel().getHref();
	}
