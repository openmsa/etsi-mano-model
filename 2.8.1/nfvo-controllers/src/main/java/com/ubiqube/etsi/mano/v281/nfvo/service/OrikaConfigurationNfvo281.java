...
import com.ubiqube.etsi.mano.v281.model.em.SubscriptionAuthenticationParamsOauth2ClientCredentials;
...
import com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.AffectedVnf;
...
import com.ubiqube.etsi.mano.v281.model.vnfm.grant.ConstraintResourceRef;
import com.ubiqube.etsi.mano.v281.model.vnfm.grant.Grant;
import com.ubiqube.etsi.mano.v281.model.vnfm.grant.GrantRequest;
import com.ubiqube.etsi.mano.v281.model.vnfm.grant.ResourceDefinition;
...
public class OrikaConfigurationNfvo281 implements OrikaMapperFactoryConfigurer {
	...
	public void configure(final MapperFactory orikaMapperFactory) {
		orikaMapperFactory.classMap(com.ubiqube.etsi.mano.v281.model.em.vnflcm.VnfInstance.class, VnfInstance.class)
