...
public class NsInstances281Sol005Controller implements NsInstances281Sol005Api {
	...
	public NsInstances281Sol005Controller(final NsInstanceGenericFrontController frontController, final MapperFacade mapper) {
	...
	public ResponseEntity<String> nsInstancesGet(final MultiValueMap<String, String> requestParams) {
		return frontController.search(requestParams, x -> mapper.map(x, NsInstance.class), null, NsInstances281Sol005Controller::makeLinks, NsInstance.class);
	}
	...
	public ResponseEntity<NsInstance> nsInstancesNsInstanceIdGet(final String nsInstanceId) {
		return frontController.findById(nsInstanceId, x -> mapper.map(x, NsInstance.class), NsInstances281Sol005Controller::makeLinks);
	}
	...
	public ResponseEntity<NsInstance> nsInstancesPost(final CreateNsRequest body) {
		...
		return frontController.create(req, x -> mapper.map(x, NsInstance.class), NsInstances281Sol005Controller::makeLinks, NsInstances281Sol005Controller::getSelfLink);
	}
