...
public interface Threshold281Mapping extends StringToUriMapping {
	@Mapping(target = "remoteResource", ignore = true)
	@Mapping(target = "subscription", ignore = true)
	Threshold map(com.ubiqube.etsi.mano.v281.model.em.vnfind.Threshold o);
	...
	com.ubiqube.etsi.mano.v281.model.em.vnfind.Threshold map(Threshold o);
