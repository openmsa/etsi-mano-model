...
import com.ubiqube.etsi.mano.v281.model.vnfm.grant.GrantVimAssets;
import com.ubiqube.etsi.mano.v281.model.vnfm.grant.ResourceDefinition;
import com.ubiqube.etsi.mano.v281.model.vnfm.grant.ZoneGroupInfo;
import com.ubiqube.etsi.mano.v281.model.vnfm.grant.ZoneInfo;

import jakarta.annotation.Nullable;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface Grant281Mapping extends VimConnectionInfo281Mapping, Connectivity281Mapping, VimResource281Mapping {
	...
	@Mapping(target = "id", ignore = true)
	ConstraintResourceRef map(com.ubiqube.etsi.mano.v281.model.vnfm.grant.ConstraintResourceRef o);
