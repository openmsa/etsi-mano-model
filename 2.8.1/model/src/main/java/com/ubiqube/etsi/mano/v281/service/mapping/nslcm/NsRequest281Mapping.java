 ...
 */
package com.ubiqube.etsi.mano.v281.service.mapping.nslcm;
...
import com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.LocationConstraintsCivicAddressElement;
import com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.ParamsForNestedNs;
...
public interface NsRequest281Mapping {

	@Mapping(target = "id", ignore = true)
	NsHeal map(HealNsRequest o);

	@Mapping(target = "id", ignore = true)
	HealVnfData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.HealVnfData o);
	...
	@Mapping(target = "id", ignore = true)
	ParamsForVnf map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.ParamsForVnf o);

	@Mapping(target = "id", ignore = true)
	NestedNsInstanceData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.NestedNsInstanceData o);

	@Mapping(target = "id", ignore = true)
	VnfInstanceData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.VnfInstanceData o);
	...
	ScaleNsData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.ScaleNsData o);

	@Mapping(target = "id", ignore = true)
	ScaleNsByStepsData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.ScaleNsByStepsData o);

	@Mapping(target = "id", ignore = true)
	ScaleNsToLevelData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.ScaleNsToLevelData o);

	@Mapping(target = "id", ignore = true)
	@Mapping(target = "scaleToLevel", ignore = true)
	@Mapping(target = "vnfdId", ignore = true)
	NsScaleInfo map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.NsScaleInfo o);

	@Mapping(target = "id", ignore = true)
	ScaleVnfData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.ScaleVnfData o);

	@Mapping(target = "id", ignore = true)
	ScaleByStepData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.ScaleByStepData o);

	@Mapping(target = "id", ignore = true)
	ScaleToLevelData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.ScaleToLevelData o);

	@Mapping(target = "id", ignore = true)
	@Mapping(target = "numberOfSteps", ignore = true)
	@Mapping(target = "scaleType", ignore = true)
	VnfScaleInfo map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.VnfScaleInfo o);

	@Mapping(target = "id", ignore = true)
	VnfLocationConstraint map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.VnfLocationConstraint o);

	// Look at RFC 7946 for geo json encoding.
	@Mapping(target = "id", ignore = true)
	@Mapping(target = "area", ignore = true)
	LocationConstraints map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.LocationConstraints o);
	...
	InstantiateVnfData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.InstantiateVnfData o);
	...
	ResourceHandle map(com.ubiqube.etsi.mano.v281.model.em.vnflcm.ResourceHandle o);
	...
	UpdateTypeEnum map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.UpdateNsRequest.UpdateTypeEnum o);

	NfpData map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.NfpData value);
