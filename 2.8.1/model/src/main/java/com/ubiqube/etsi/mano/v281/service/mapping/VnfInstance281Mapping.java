...
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.CpProtocolInfo;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.ExtLinkPortInfo;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.ExtManagedVirtualLinkInfo;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.ExtVirtualLinkInfo;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.IpOverEthernetAddressInfo;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.IpOverEthernetAddressInfoIpAddresses;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.MonitoringParameter;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.VnfExtCpInfo;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.VnfInstanceInstantiatedVnfInfo;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.VnfLinkPortInfo;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.VnfVirtualLinkResourceInfo;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.VnfcResourceInfo;
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.VnfcResourceInfoVnfcCpInfo;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface VnfInstance281Mapping extends VimConnectionInfo281Mapping, Connectivity281Mapping, VimResource281Mapping {
...
//	@Mapping(target = "id", ignore = true)
	VnfInstance map(com.ubiqube.etsi.mano.v281.model.em.vnflcm.VnfInstance pkg);
	...
	com.ubiqube.etsi.mano.v281.model.em.vnflcm.ScaleInfo map(ScaleInfo o);
	...
	@Mapping(target = "vnfdId", ignore = true)
	@Mapping(target = "id", ignore = true)
	ScaleInfo map(com.ubiqube.etsi.mano.v281.model.em.vnflcm.ScaleInfo si);

	@Mapping(target = "vnfdId", ignore = true)
	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "zoneId", ignore = true)
	VirtualStorageResourceInfo map(com.ubiqube.etsi.mano.v281.model.em.vnflcm.VirtualStorageResourceInfo virtualStorageResourceInfo);

	com.ubiqube.etsi.mano.v281.model.em.vnflcm.VirtualStorageResourceInfo map(VirtualStorageResourceInfo vsri);
