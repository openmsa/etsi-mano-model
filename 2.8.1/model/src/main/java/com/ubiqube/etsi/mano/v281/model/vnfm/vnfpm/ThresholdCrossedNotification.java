...
import com.ubiqube.etsi.mano.dao.mano.pm.CrossingDirectionType;
 ...
 * crossed. The timing of sending this notification is determined by the
 ...
 * has been crossed.
 */
@Schema(description = "This type represents a notification that is sent when a threshold has been crossed. The timing of sending this notification is determined by the capability of the producing entity to evaluate the threshold crossing condition. The notification shall be triggered by the VNFM when a threshold has been crossed. ")
@Validated
...
public class ThresholdCrossedNotification {
	...
	@JsonProperty("_links")
	private ThresholdCrossedNotificationLinks links = null;
	...
	public ThresholdCrossedNotification links(final ThresholdCrossedNotificationLinks _links) {
		this.links = _links;
		return this;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.id, thresholdCrossedNotification.id) &&
				...
				Objects.equals(this.links, thresholdCrossedNotification.links);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, notificationType, timeStamp, thresholdId, crossingDirection, objectType, objectInstanceId, subObjectInstanceId, performanceMetric, performanceValue, context, links);
	}
