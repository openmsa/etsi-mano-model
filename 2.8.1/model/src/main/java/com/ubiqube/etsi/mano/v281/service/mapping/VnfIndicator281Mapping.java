...
public interface VnfIndicator281Mapping {
	...
	VnfIndicator map(com.ubiqube.etsi.mano.v281.model.em.vnfind.VnfIndicator o);

	@Mapping(target = "links", ignore = true)
	@Mapping(target = "value", ignore = true)
	@Mapping(target = "name", source = "toscaName")
	com.ubiqube.etsi.mano.v281.model.em.vnfind.VnfIndicator map(VnfIndicator o);
}
