...
import com.ubiqube.etsi.mano.v281.model.em.vnflcm.ScaleInfo;
...
import com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.NsVirtualLinkInfo;
import com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.VnffgInfo;

import jakarta.annotation.Nullable;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface NsInstance281Mapping extends VimResource281Mapping {
	...
	@Nullable
	default com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.NsCpHandle mapSetDb(final @Nullable Set<NsCpHandle> value) {
	...
	@Mapping(target = "scaleLevel", ignore = true)
	@Mapping(target = "vnfdId", ignore = true)
	com.ubiqube.etsi.mano.dao.mano.ScaleInfo map(com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.NsScaleInfo o);
	...
	@Nullable
	default Set<NsCpHandle> mapSet(final @Nullable com.ubiqube.etsi.mano.v281.model.nfvo.nslcm.NsCpHandle value) {
		if (null == value) {
			return Set.of();
		}
