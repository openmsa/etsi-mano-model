...
import com.ubiqube.etsi.mano.v281.model.em.vnfind.PmJobReports;
import com.ubiqube.etsi.mano.v281.service.mapping.subscription.BaseSubscription281Mapping;

import jakarta.annotation.Nullable;
import jakarta.validation.Valid;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface PmJob281Mapping extends BaseSubscription281Mapping, DateTimeMapping {
	...
	PmJob map(com.ubiqube.etsi.mano.v281.model.em.vnfind.PmJob o);

	@Mapping(target = "id", ignore = true)
	PmReport map(PmJobReports o);

	@Mapping(target = "links", ignore = true)
	com.ubiqube.etsi.mano.v281.model.em.vnfind.PmJob map(PmJob o);
	...
	com.ubiqube.etsi.mano.v281.model.em.vnfind.PerformanceReport map(PerformanceReport x);
