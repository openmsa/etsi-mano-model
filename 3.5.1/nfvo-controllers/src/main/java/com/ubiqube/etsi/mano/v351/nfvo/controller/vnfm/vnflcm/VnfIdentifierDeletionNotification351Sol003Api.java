...
@RequestMapping(value = "/sol003/vnflcm/v2/vnf_instances/notification", headers = "Version=2.1.0")
@RolesAllowed({ "ROLE_VNFM" })
@Validated
public interface VnfIdentifierDeletionNotification351Sol003Api {
	...
	ResponseEntity<Void> deletionNotificationPost(
			@Parameter(in = ParameterIn.DEFAULT, description = "A notification about the deletion of a VNF identifier and the related \"Individual VNF instance\" resource.", required = true, schema = @Schema()) @Valid @RequestBody final VnfIdentifierDeletionNotification body);
}
