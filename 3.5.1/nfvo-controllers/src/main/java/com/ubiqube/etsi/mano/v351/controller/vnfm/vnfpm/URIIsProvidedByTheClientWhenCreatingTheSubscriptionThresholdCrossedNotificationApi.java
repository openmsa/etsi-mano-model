...
import com.ubiqube.etsi.mano.vnfm.v451.model.vnfpm.ProblemDetails;
import com.ubiqube.etsi.mano.vnfm.v451.model.vnfpm.ThresholdCrossedNotification;
...
public interface URIIsProvidedByTheClientWhenCreatingTheSubscriptionThresholdCrossedNotificationApi {
    ...
    @RequestMapping(value = "/URI_is_provided_by_the_client_when_creating_the_subscription-ThresholdCrossedNotification",
    ...
    default ResponseEntity<Void> uRIIsProvidedByTheClientWhenCreatingTheSubscriptionThresholdCrossedNotificationPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. " ,required=true,schema=@Schema()) @RequestHeader(value="Version", required=true) String version, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 " ,required=true,schema=@Schema()) @RequestHeader(value="Content-Type", required=true) String contentType, @Parameter(in = ParameterIn.DEFAULT, description = "Notification about performance information availability.
", required=true, schema=@Schema()) @Valid @RequestBody ThresholdCrossedNotification body, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. " ,schema=@Schema()) @RequestHeader(value="Authorization", required=false) String authorization) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default URIIsProvidedByTheClientWhenCreatingTheSubscriptionThresholdCrossedNotificationApi interface so no example is generated");
        }
