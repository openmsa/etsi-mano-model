...
@Validated
public interface VnfIdentifierCreationNotification351Sol003Api {
	...
	ResponseEntity<Void> creationNotificationPost(
			@Parameter(in = ParameterIn.DEFAULT, description = "A notification about the creation of a VNF identifier and the related \"Individual VNF instance\" resource.", required = true, schema = @Schema()) @Valid @RequestBody final VnfIdentifierCreationNotification body);
}
