...
public class Thresholds351Sol002Controller implements Thresholds351Sol002Api {
	...
	public Thresholds351Sol002Controller(final VnfmThresholdFrontController vnfmThresholdFrontController, final Threshold351Mapping mapper) {
	...
	public ResponseEntity<Threshold> thresholdsPost(@Valid final CreateThresholdRequest createThresholdRequest) {
		...
		return vnfmThresholdFrontController.thresholdsCreate(req, x -> mapper.map(x), Thresholds351Sol002Controller::makeLinks, Thresholds351Sol002Controller::getSelfLink);
	}
	...
	public ResponseEntity<Threshold> thresholdsThresholdIdGet(final String thresholdId) {
		return vnfmThresholdFrontController.findById(thresholdId, x -> mapper.map(x), Thresholds351Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<String> thresholdsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return vnfmThresholdFrontController.search(requestParams, nextpageOpaqueMarker, x -> mapper.map(x), Thresholds351Sol002Controller::makeLinks, Threshold.class);
	}
