...
public class PmJobs351Sol003Controller implements PmJobs351Sol003Api {
	...
	public PmJobs351Sol003Controller(final VnfmPmGenericFrontController vnfmPmGenericFrontController, final PmJob351Mapping mapper) {
	...
	public ResponseEntity<String> pmJobsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return vnfmPmGenericFrontController.search(requestParams, x -> mapper.map(x), PmJobs351Sol003Controller::makeLinks, PmJob.class);
	}
	...
	public ResponseEntity<PmJob> pmJobsPmJobIdGet(final String pmJobIdn) {
		return vnfmPmGenericFrontController.findById(UUID.fromString(pmJobIdn), x -> mapper.map(x), PmJobs351Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<PmJob> pmJobsPost(@Valid final CreatePmJobRequest createPmJobRequest) {
		...
		return vnfmPmGenericFrontController.pmJobsPost(req, x -> mapper.map(x), PmJobs351Sol003Controller::makeLinks, PmJobs351Sol003Controller::makeSelf);
	}
