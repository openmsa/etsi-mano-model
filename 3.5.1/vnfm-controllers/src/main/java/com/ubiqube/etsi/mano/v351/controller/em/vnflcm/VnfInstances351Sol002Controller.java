...
import com.ubiqube.etsi.mano.v351.controller.vnfm.vnflcm.VnfLcmOpOccs351Sol003Api;
...
public class VnfInstances351Sol002Controller implements VnfInstances351Sol002Api {
	...
	public VnfInstances351Sol002Controller(final VnfInstanceGenericFrontController frontController, final MapperFacade mapper) {
	...
	public ResponseEntity<String> vnfInstancesGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return frontController.search(requestParams, x -> mapper.map(x, VnfInstance.class), nextpageOpaqueMarker, VnfInstances351Sol002Controller::makeLinks, VnfInstance.class);
	}
	...
	public ResponseEntity<VnfInstance> vnfInstancesVnfInstanceIdGet(final String vnfInstanceId) {
		return frontController.findById(getSafeUUID(vnfInstanceId), x -> mapper.map(x, VnfInstance.class), VnfInstances351Sol002Controller::makeLinks, "");
	}
