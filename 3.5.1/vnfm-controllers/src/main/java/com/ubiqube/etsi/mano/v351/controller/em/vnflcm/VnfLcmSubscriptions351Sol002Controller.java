 ...
 */
package com.ubiqube.etsi.mano.v351.controller.em.vnflcm;
...
import com.ubiqube.etsi.mano.v351.service.SubscriptionLinkable351Vnfm;
...
public class VnfLcmSubscriptions351Sol002Controller implements VnfLcmSubscriptions351Sol002Api, SubscriptionLinkable351Vnfm {
	...
	public VnfLcmSubscriptions351Sol002Controller(final VnfLcmSubscriptionFrontController frontController, final LccnSubscription351Mapping mapper) {
	...
	public ResponseEntity<List<LccnSubscription>> subscriptionsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return frontController.search(requestParams, nextpageOpaqueMarker, x -> mapper.map(x, LifecycleChangeNotificationsFilter.class), VnfLcmSubscriptions351Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<LccnSubscription> subscriptionsPost(@Valid final LccnSubscriptionRequest body) {
		...
		return frontController.create(req, x -> mapper.map(x, LifecycleChangeNotificationsFilter.class), VnfLcmSubscriptions351Sol002Api.class, VnfLcmSubscriptions351Sol002Controller::makeLinks, VnfLcmSubscriptions351Sol002Controller::getSelfLink);
	}
	...
	public ResponseEntity<LccnSubscription> subscriptionsSubscriptionIdGet(final String subscriptionId) {
		return frontController.findById(subscriptionId, x -> mapper.map(x, LifecycleChangeNotificationsFilter.class), VnfLcmSubscriptions351Sol002Controller::makeLinks);
	}
