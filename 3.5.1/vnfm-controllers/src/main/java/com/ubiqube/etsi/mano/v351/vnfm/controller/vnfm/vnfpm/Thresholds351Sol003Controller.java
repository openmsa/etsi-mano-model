 ...
 */
package com.ubiqube.etsi.mano.v351.vnfm.controller.vnfm.vnfpm;
...
public class Thresholds351Sol003Controller implements Thresholds351Sol003Api {
	...
	private final Threshold351Mapping mapper;

	public Thresholds351Sol003Controller(final VnfmThresholdFrontController vnfmThresholdFrontController, final Threshold351Mapping mapper) {
	...
	public ResponseEntity<Threshold> thresholdsPost(@Valid final CreateThresholdRequest createThresholdRequest) {
		...
		return vnfmThresholdFrontController.thresholdsCreate(req, x -> mapper.map(x), Thresholds351Sol003Controller::makeLinks, Thresholds351Sol003Controller::getSelfLink);
	}
	...
	public ResponseEntity<Threshold> thresholdsThresholdIdGet(final String thresholdId) {
		return vnfmThresholdFrontController.findById(thresholdId, x -> mapper.map(x), Thresholds351Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<String> thresholdsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return vnfmThresholdFrontController.search(requestParams, nextpageOpaqueMarker, x -> mapper.map(x), Thresholds351Sol003Controller::makeLinks, Threshold.class);
	}
