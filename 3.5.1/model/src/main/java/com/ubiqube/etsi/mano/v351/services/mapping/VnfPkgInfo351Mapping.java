...
import com.ubiqube.etsi.mano.v351.model.nfvo.vnf.VnfPackageArtifactInfo;
...
public interface VnfPkgInfo351Mapping extends StringToUriMapping {
	...
	Checksum map(com.ubiqube.etsi.mano.v351.model.nfvo.vnfsnapshotpkgm.Checksum o);
	...
	@Mapping(target = "sha256", ignore = true)
	@Mapping(target = "sha512", ignore = true)
	PkgChecksum mapToPkgChecksum(com.ubiqube.etsi.mano.v351.model.nfvo.vnfsnapshotpkgm.Checksum o);
