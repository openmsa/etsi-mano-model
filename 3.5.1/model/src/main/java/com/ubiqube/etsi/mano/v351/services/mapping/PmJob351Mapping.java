...
import com.ubiqube.etsi.mano.v351.services.mapping.subscription.BaseSubscription351Mapping;
import com.ubiqube.etsi.mano.v351.model.em.vnfpm.CreatePmJobRequest;
import com.ubiqube.etsi.mano.v351.model.em.vnfpm.PmJobReports;

import jakarta.annotation.Nullable;
import jakarta.validation.Valid;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface PmJob351Mapping extends BaseSubscription351Mapping, DateTimeMapping {
	...
	PmJob map(com.ubiqube.etsi.mano.v351.model.em.vnfpm.PmJob o);

	@Mapping(target = "id", ignore = true)
	PmReport map(PmJobReports o);

	@Mapping(target = "links", ignore = true)
	com.ubiqube.etsi.mano.v351.model.em.vnfpm.PmJob map(PmJob o);
	...
	com.ubiqube.etsi.mano.v351.model.em.vnfpm.PerformanceReport map(PerformanceReport x);
