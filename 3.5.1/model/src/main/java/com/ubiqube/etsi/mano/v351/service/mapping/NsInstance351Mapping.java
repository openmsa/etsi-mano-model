...
import com.ubiqube.etsi.mano.v351.model.em.vnflcm.IpOverEthernetAddressInfoIpAddresses;
...
import com.ubiqube.etsi.mano.v351.model.em.vnflcm.VnfInstanceInstantiatedVnfInfo;
import com.ubiqube.etsi.mano.v351.model.em.vnflcm.VnfcResourceInfo;
import com.ubiqube.etsi.mano.v351.model.nfvo.nslcm.NsInstance;
import com.ubiqube.etsi.mano.v351.model.nfvo.nslcm.NsVirtualLinkInfo;
import com.ubiqube.etsi.mano.v351.model.nfvo.nslcm.VnffgInfo;
...
public interface NsInstance351Mapping extends VimResource351Mapping {
	...
	com.ubiqube.etsi.mano.v351.model.nfvo.nslcm.NsScaleInfo map(com.ubiqube.etsi.mano.dao.mano.ScaleInfo o);
	...
	@Nullable
	default com.ubiqube.etsi.mano.v351.model.nfvo.nslcm.NsCpHandle mapSetDb(final @Nullable Set<NsCpHandle> value) {
	...
	com.ubiqube.etsi.mano.v351.model.nfvo.nslcm.NsCpHandle map(@Nullable NsCpHandle value);
	...
	@Mapping(target = "scaleLevel", ignore = true)
	@Mapping(target = "vnfdId", ignore = true)
	com.ubiqube.etsi.mano.dao.mano.ScaleInfo map(com.ubiqube.etsi.mano.v351.model.nfvo.nslcm.NsScaleInfo o);
	...
	com.ubiqube.etsi.mano.dao.mano.VnfMonitoringParameter map(com.ubiqube.etsi.mano.v351.model.em.vnflcm.MonitoringParameter o);
	...
	@Mapping(target = "audit", ignore = true)
	VnfMonitoringParameter map(com.ubiqube.etsi.mano.v351.model.nfvo.nslcm.VnfMonitoringParameter o);
	...
	@Nullable
	default Set<NsCpHandle> mapSet(final @Nullable com.ubiqube.etsi.mano.v351.model.nfvo.nslcm.NsCpHandle value) {
		if (null == value) {
			return Set.of();
		}
	...
	@Mapping(target = "id", ignore = true)
	NsCpHandle map(com.ubiqube.etsi.mano.v351.model.nfvo.nslcm.NsCpHandle o);

	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "zoneId", ignore = true)
	VirtualStorageResourceInfo map(com.ubiqube.etsi.mano.v351.model.em.vnflcm.VirtualStorageResourceInfo p);
