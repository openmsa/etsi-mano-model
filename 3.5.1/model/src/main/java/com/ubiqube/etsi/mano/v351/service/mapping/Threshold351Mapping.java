...
public interface Threshold351Mapping extends StringToUriMapping {
	@Mapping(target = "remoteResource", ignore = true)
	@Mapping(target = "subscription", ignore = true)
	Threshold map(com.ubiqube.etsi.mano.v351.model.em.vnfpm.Threshold o);
	...
	com.ubiqube.etsi.mano.v351.model.em.vnfpm.Threshold map(Threshold o);
