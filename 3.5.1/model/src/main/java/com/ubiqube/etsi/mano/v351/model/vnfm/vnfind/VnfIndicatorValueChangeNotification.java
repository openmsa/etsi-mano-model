...
/**
 * This type represents a VNF indicator value change notification. It shall
 * comply with the provisions defined in table 8.5.2.5-1. The notification shall
 * be triggered by the VNFM when the value of an indicator has changed. NOTE:
