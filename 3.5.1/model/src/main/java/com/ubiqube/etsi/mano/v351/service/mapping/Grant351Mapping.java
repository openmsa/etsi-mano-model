...
import com.ubiqube.etsi.mano.v351.model.vnfm.grant.GrantInfo;
import com.ubiqube.etsi.mano.v351.model.vnfm.grant.GrantRequest;
import com.ubiqube.etsi.mano.v351.model.vnfm.grant.GrantVimAssets;
import com.ubiqube.etsi.mano.v351.model.vnfm.grant.ResourceDefinition;
import com.ubiqube.etsi.mano.v351.model.vnfm.grant.SnapshotResourceDefinition;
import com.ubiqube.etsi.mano.v351.model.vnfm.grant.ZoneGroupInfo;
import com.ubiqube.etsi.mano.v351.model.vnfm.grant.ZoneInfo;
...
public interface Grant351Mapping extends VimConnectionInfo351Mapping, Connectivity351Mapping, VimResource351Mapping {
	...
	VimConstraint map(com.ubiqube.etsi.mano.v351.model.vnfm.grant.VimConstraint o);

	@Mapping(target = "scaleToLevel", ignore = true)
	@Mapping(target = "id", ignore = true)
	ScaleInfo map(com.ubiqube.etsi.mano.v351.model.em.vnflcm.ScaleInfo o);
	...
	@Mapping(target = "id", ignore = true)
	ConstraintResourceRef map(com.ubiqube.etsi.mano.v351.model.vnfm.grant.ConstraintResourceRef o);
	...
	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "id", ignore = true)
	PlacementConstraint map(com.ubiqube.etsi.mano.v351.model.vnfm.grant.PlacementConstraint o);
	...
	com.ubiqube.etsi.mano.v351.model.vnfm.grant.PlacementConstraint.ScopeEnum map(PlacementConstraint.ScopeEnum o);
}
