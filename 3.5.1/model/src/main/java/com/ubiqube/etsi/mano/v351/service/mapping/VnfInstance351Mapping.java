...
import com.ubiqube.etsi.mano.v351.model.em.vnflcm.IpOverEthernetAddressInfo;
import com.ubiqube.etsi.mano.v351.model.em.vnflcm.IpOverEthernetAddressInfoIpAddresses;
import com.ubiqube.etsi.mano.v351.model.em.vnflcm.MonitoringParameter;
...
//	@Mapping(target = "id", ignore = true)
	VnfInstance map(com.ubiqube.etsi.mano.v351.model.em.vnflcm.VnfInstance pkg);
	...
	com.ubiqube.etsi.mano.v351.model.em.vnflcm.ScaleInfo map(ScaleInfo o);
	...
	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "zoneId", ignore = true)
	VirtualStorageResourceInfo map(com.ubiqube.etsi.mano.v351.model.em.vnflcm.VirtualStorageResourceInfo virtualStorageResourceInfo);

	com.ubiqube.etsi.mano.v351.model.em.vnflcm.VirtualStorageResourceInfo map(VirtualStorageResourceInfo vsri);
