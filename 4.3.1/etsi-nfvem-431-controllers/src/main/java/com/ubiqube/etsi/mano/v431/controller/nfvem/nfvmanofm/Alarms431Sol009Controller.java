...
@RestController
public class Alarms431Sol009Controller implements Alarms431Sol009Api {
	...
	@Override
	public ResponseEntity<AlarmModifications> alarmsAlarmIdPatch(final String contentType, final String alarmId, @Valid final AlarmModifications body) {
		// TODO Auto-generated method stub
		return null;
	}
