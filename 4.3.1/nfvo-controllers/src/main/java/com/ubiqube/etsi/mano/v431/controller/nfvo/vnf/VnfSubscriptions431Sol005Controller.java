 ...
 */
package com.ubiqube.etsi.mano.v431.controller.nfvo.vnf;
...
@RestController
public class VnfSubscriptions431Sol005Controller implements VnfSubscriptions431Sol005Api, SubscriptionLinkable431Nfvo {
	...
	public VnfSubscriptions431Sol005Controller(final VnfSubscriptionSol005FrontController vnfSubscriptionSol03FrontController, final PkgmSubscriptionRequest431Mapping mapper) {
	...
	public String makeSelfLink(final String id) {
		return linkTo(methodOn(VnfSubscriptions431Sol005Api.class).subscriptionsSubscriptionIdGet(id)).withSelfRel().getHref();
	}
