 ...
 */
package com.ubiqube.etsi.mano.v431.controller.vnfm.vnf;
...
import com.ubiqube.etsi.mano.v431.controller.nfvo.vnf.VnfSubscriptions431Sol005Api;
import com.ubiqube.etsi.mano.v431.controller.nfvo.vnf.VnfSubscriptions431Sol005Controller;
...
import com.ubiqube.etsi.mano.v431.model.nfvo.vnf.PkgmSubscriptionLinks;
...
@RestController
public class VnfSubscriptions431Sol003Controller implements VnfSubscriptions431Sol003Api, SubscriptionLinkable431Nfvo {
	private final VnfSubscriptionSol005FrontController vnfSubscriptionSol03FrontController;
	private final PkgmSubscriptionRequest431Mapping mapper;

	public VnfSubscriptions431Sol003Controller(final VnfSubscriptionSol005FrontController vnfSubscriptionSol03FrontController, final PkgmSubscriptionRequest431Mapping mapper) {
	...
	public ResponseEntity<PkgmSubscription> subscriptionsSubscriptionIdGet(final String subscriptionId) {
		return vnfSubscriptionSol03FrontController.findById(subscriptionId, x -> mapper.map(x, PkgmNotificationsFilter.class), VnfSubscriptions431Sol005Controller::makeLinks);
	}
