...
//  private List<VnfcInfo> vnfcInfo = null;
	 ...
	 * See note 5 and note 6. It is possible to have several
	 ...
	 * (refer to clause 5.5.3.5). Even though externally-managed internal VLs are
	 * also used for VNF-internal connectivity, they shall not be listed in the
	 ...
	 * VNF instance. See note 6. Even though externally-managed internal VLs are
	 * also used for VNF-internal connectivity, they shall not be listed in the
	 * \"vnfVirtualLinkResourceInfo\" attribute as this would be redundant.
	 *
