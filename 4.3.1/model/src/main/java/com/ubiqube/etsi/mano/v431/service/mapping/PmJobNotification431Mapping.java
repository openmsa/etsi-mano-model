...
public interface PmJobNotification431Mapping {
	...
	PerformanceInformationAvailableNotification map(com.ubiqube.etsi.mano.v431.model.em.vnfpm.PerformanceInformationAvailableNotification body);
	...
	ThresholdCrossedNotification map(com.ubiqube.etsi.mano.v431.model.em.vnfpm.ThresholdCrossedNotification body);
