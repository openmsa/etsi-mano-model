...
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.ExtManagedVirtualLinkInfo;
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.ExtVirtualLinkInfo;
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.IpOverEthernetAddressInfo;
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.IpOverEthernetAddressInfoIpAddresses;
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.MonitoringParameter;
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.VirtualCpInfo;
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.VnfExtCpInfo;
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.VnfInstanceInstantiatedVnfInfo;
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.VnfLinkPortInfo;
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.VnfVirtualLinkResourceInfo;
...
public interface VnfInstance431Mapping extends VimConnectionInfo431Mapping, Connectivity431Mapping {
	...
	com.ubiqube.etsi.mano.v431.model.em.vnflcm.VnfInstance map(VnfInstance vnfInst);
	...
	@Mapping(target = "certificateContentId", ignore = true)
	@Mapping(target = "id", ignore = true)
	McioInfo map(com.ubiqube.etsi.mano.v431.model.em.vnflcm.McioInfo mi);

	com.ubiqube.etsi.mano.v431.model.em.vnflcm.McioInfo map(McioInfo mi);
	...
	@Mapping(target = "id", ignore = true)
	VipCpInfo map(com.ubiqube.etsi.mano.v431.model.em.vnflcm.VipCpInfo vc);

	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "zoneId", ignore = true)
	VirtualStorageResourceInfo map(com.ubiqube.etsi.mano.v431.model.em.vnflcm.VirtualStorageResourceInfo virtualStorageResourceInfo);

	com.ubiqube.etsi.mano.v431.model.em.vnflcm.VirtualStorageResourceInfo map(VirtualStorageResourceInfo vsri);
	...
	@Mapping(target = "id", ignore = true)
	AdditionalServiceInfo map(com.ubiqube.etsi.mano.v431.model.em.vnflcm.AdditionalServiceInfo asi);

	@Mapping(target = "id", ignore = true)
	ServicePortInfo map(com.ubiqube.etsi.mano.v431.model.em.vnflcm.ServicePortInfo spi);
	...
	VirtualCpAddressInfo map(com.ubiqube.etsi.mano.v431.model.em.vnflcm.VirtualCpAddressInfo vcp);
