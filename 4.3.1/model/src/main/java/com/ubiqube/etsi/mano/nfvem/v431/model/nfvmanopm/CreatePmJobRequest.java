...
public class CreatePmJobRequest {
	 ...
	 * the instance of the measure object according to their type. See also
	 * definitions in clause 8.2 of ETSI GS NFV-IFA 031. If more than one identifier
	 * is provided, values shall all refer to measured object instances of the same
	 * type, for which the same criteria is then applicable.
	 *
	 ...
	 * a sub-object is defined in clause 8.2 of ETSI GS NFV-IFA 031 for the related
