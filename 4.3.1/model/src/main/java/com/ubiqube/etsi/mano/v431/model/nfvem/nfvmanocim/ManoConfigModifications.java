...
import com.ubiqube.etsi.mano.v431.model.nfvem.nfvmanocim.ClockSyncInfo;
import com.ubiqube.etsi.mano.v431.model.nfvem.nfvmanocim.ManoConfigModificationsManoServiceModifications;
...
public class ManoConfigModifications   {
  ...
  public ManoConfigModifications clockSyncs(Map<String, ClockSyncInfo> clockSyncs) {
    this.clockSyncs = clockSyncs;
    return this;
  }

  public ManoConfigModifications putClockSyncsItem(String key, ClockSyncInfo clockSyncsItem) {
