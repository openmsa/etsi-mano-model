...
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.SubscriptionAuthenticationParamsBasic;
...
/**
 * * NOTE: The clientId and clientPassword passed in a subscription shall not be
 * the same as the clientId and clientPassword that are used to obtain
 * authorization for API requests. Client credentials may differ between
 * subscriptions. The value of clientPassword should be generated by a random
 * process
 */
