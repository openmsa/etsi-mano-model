...
import com.ubiqube.etsi.mano.v431.model.nfvo.nslcm.NsVirtualLinkInfo;
import com.ubiqube.etsi.mano.v431.model.nfvo.nslcm.VnffgInfo;
...
public interface NsInstance431Mapping {
	...
	com.ubiqube.etsi.mano.v431.model.nfvo.nslcm.NsScaleInfo map(com.ubiqube.etsi.mano.dao.mano.ScaleInfo o);
	...
	@Mapping(target = "id", ignore = true)
	@Mapping(target = "vnfdId", ignore = true)
	com.ubiqube.etsi.mano.dao.mano.ScaleInfo map(com.ubiqube.etsi.mano.v431.model.nfvo.nslcm.NsScaleInfo o);
	...
	com.ubiqube.etsi.mano.dao.mano.VnfMonitoringParameter map(com.ubiqube.etsi.mano.v431.model.em.vnflcm.MonitoringParameter o);
	...
	@Mapping(target = "audit", ignore = true)
	VnfMonitoringParameter map(com.ubiqube.etsi.mano.v431.model.nfvo.nslcm.VnfMonitoringParameter o);
	...
	@Nullable
	default Set<NsCpHandle> mapSet(final @Nullable com.ubiqube.etsi.mano.v431.model.nfvo.nslcm.NsCpHandle value) {
		if (null == value) {
			return Set.of();
		}
	...
	@Mapping(target = "id", ignore = true)
	NsCpHandle map(com.ubiqube.etsi.mano.v431.model.nfvo.nslcm.NsCpHandle o);
	...
	VirtualStorageResourceInfo map(com.ubiqube.etsi.mano.v431.model.em.vnflcm.VirtualStorageResourceInfo p);
