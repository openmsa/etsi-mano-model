...
public interface LogmSubscription451Mapping extends BaseSubscription431Mapping {

	@Mapping(target = "filter", source = "filters", qualifiedByName = "toObject")
	@Mapping(target = "links", ignore = true)
	LogmSubscription map(Subscription o, @Context final Class<LogmNotificationsFilter> clazz);
	...
	@Mapping(target = "filter", source = "filters", qualifiedByName = "toObject")
	LogmSubscriptionRequest mapToLccnSubscriptionRequest(Subscription o, @Context final Class<LogmNotificationsFilter> clazz);
