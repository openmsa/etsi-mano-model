 ...
 */
package com.ubiqube.etsi.mano.v431.service.mapping.sol009;
...
import com.ubiqube.etsi.mano.v431.model.nfvem.nfvmanologm.LoggingJobConfigSecurityConfLogFileEncryption;
import com.ubiqube.etsi.mano.v431.model.nfvem.nfvmanologm.LoggingJobMessagesCriteriaMatchingPatterns;
import com.ubiqube.etsi.mano.v431.model.nfvem.nfvmanopm.ManoManagedObjectReference;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface Logm451Mapping {
	@Mapping(target = "links", ignore = true)
	LogReport map(com.ubiqube.etsi.mano.dao.mano.sol009.logm.LogReport o);

	CompileLogRequest map(com.ubiqube.etsi.mano.v431.model.nfvem.nfvmanologm.CompileLogRequest body);
	...
	CreateLoggingJobRequest map(com.ubiqube.etsi.mano.v431.model.nfvem.nfvmanologm.CreateLoggingJobRequest body);

	@Mapping(target = "id", ignore = true)
	LogFileEncryption map(LoggingJobConfigSecurityConfLogFileEncryption o);

	@Mapping(target = "id", ignore = true)
	LoggingJobCriteria map(com.ubiqube.etsi.mano.v431.model.nfvem.nfvmanologm.LoggingJobCriteria o);

	@Mapping(target = "id", ignore = true)
	LoggingJobMessagesCriteria map(com.ubiqube.etsi.mano.v431.model.nfvem.nfvmanologm.LoggingJobMessagesCriteria o);

	@Mapping(target = "id", ignore = true)
	MatchingPatterns map(LoggingJobMessagesCriteriaMatchingPatterns o);

	@Mapping(target = "id", ignore = true)
	LoggingJobSystemCriteria map(com.ubiqube.etsi.mano.v431.model.nfvem.nfvmanologm.LoggingJobSystemCriteria o);
