...
import com.ubiqube.etsi.mano.em.v431.model.vnflcm.TerminateVnfRequest.TerminationTypeEnum;
...
public class HttpGateway431 extends AbstractHttpGateway {
	...
	public HttpGateway431(final ObjectProvider<VnfmFactory> vnfmFactory, final ObjectProvider<NfvoFactory> nfvoFactory, final MapperFacade mapper) {
	...
	public Class<?> getVnfThresholdClass() {
		return com.ubiqube.etsi.mano.em.v431.model.vnfpm.Threshold.class;
	}
