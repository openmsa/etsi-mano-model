...
import com.ubiqube.etsi.mano.v431.model.em.vnflcm.VnfLcmOpOccResourceChanges;
...
//	@Mapping(target = "parameters", source = "operationParams")
	...
	AffectedVipCp map(com.ubiqube.etsi.mano.v431.model.em.vnflcm.AffectedVipCp o);
