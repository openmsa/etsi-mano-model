...
import com.ubiqube.etsi.mano.v431.model.nfvo.vnf.VnfPackageArtifactInfo;
import com.ubiqube.etsi.mano.v431.model.nfvo.vnf.VnfPackageSoftwareImageInfo;
...
public interface VnfPkgInfo431Mapping extends StringToUriMapping {
	...
	Checksum map(com.ubiqube.etsi.mano.v431.model.nfvo.vnfsnapshotpkgm.Checksum o);
	...
	@Mapping(target = "sha256", ignore = true)
	@Mapping(target = "sha512", ignore = true)
	PkgChecksum mapToPkgChecksum(com.ubiqube.etsi.mano.v431.model.nfvo.vnfsnapshotpkgm.Checksum o);
