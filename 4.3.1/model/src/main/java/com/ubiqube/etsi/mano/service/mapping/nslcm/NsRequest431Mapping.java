 ...
 */
package com.ubiqube.etsi.mano.service.mapping.nslcm;
...
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ParamsForNestedNs;
...
public interface NsRequest431Mapping {
	...
	@Mapping(target = "id", ignore = true)
	HealVnfData map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.HealVnfData o);
	...
	@Mapping(target = "id", ignore = true)
	ParamsForVnf map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ParamsForVnf o);

	@Mapping(target = "id", ignore = true)
	NestedNsInstanceData map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.NestedNsInstanceData o);

	@Mapping(target = "id", ignore = true)
	VnfInstanceData map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.VnfInstanceData o);
	...
	ScaleNsData map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ScaleNsData o);

	@Mapping(target = "id", ignore = true)
	ScaleNsByStepsData map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ScaleNsByStepsData o);

	@Mapping(target = "id", ignore = true)
	ScaleNsToLevelData map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ScaleNsToLevelData o);

	@Mapping(target = "id", ignore = true)
	@Mapping(target = "scaleToLevel", ignore = true)
	@Mapping(target = "vnfdId", ignore = true)
	NsScaleInfo map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.NsScaleInfo o);

	@Mapping(target = "id", ignore = true)
	ScaleVnfData map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ScaleVnfData o);

	@Mapping(target = "id", ignore = true)
	ScaleByStepData map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ScaleByStepData o);

	@Mapping(target = "id", ignore = true)
	ScaleToLevelData map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ScaleToLevelData o);

	@Mapping(target = "id", ignore = true)
	@Mapping(target = "numberOfSteps", ignore = true)
	@Mapping(target = "scaleType", ignore = true)
	VnfScaleInfo map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.VnfScaleInfo o);

	@Mapping(target = "id", ignore = true)
	VnfLocationConstraint map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.VnfLocationConstraint o);

	// Look at RFC 7946 for geo json encoding.
	@Mapping(target = "id", ignore = true)
	@Mapping(target = "area", ignore = true)
	LocationConstraints map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.LocationConstraints o);
	...
	UpdateTypeEnum map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.UpdateNsRequest.UpdateTypeEnum o);

	NfpData map(com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.NfpData value);
