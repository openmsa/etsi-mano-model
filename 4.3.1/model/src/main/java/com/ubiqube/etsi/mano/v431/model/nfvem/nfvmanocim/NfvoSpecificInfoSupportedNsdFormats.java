...
public class NfvoSpecificInfoSupportedNsdFormats   {
   ...
   * @return nsdFormat
   **/
  @Schema(requiredMode = RequiredMode.REQUIRED, description = "Name of the NSD format. Permitted values:   - TOSCA: The VNFD follows TOSCA definition, according to ETSI   GS NFV-SOL 001 standard.   - YANG: The VNFD follows YANG definition according to ETSI   GS NFV-SOL 006 standard. ")
      @NotNull
