...
public class PmJobCriteria   {
  ...
  /**
   * Specifies the periodicity at which the producer will collect performance information. The unit shall be seconds. See note 1 and note 2. 
   * @return collectionPeriod
   **/
  @Schema(required = true, description = "Specifies the periodicity at which the producer will collect performance information. The unit shall be seconds. See note 1 and note 2. ")
      @NotNull
  ...
  /**
   * Specifies the periodicity at which the producer will report to the API consumer about performance information. The unit shall be seconds. See note 1 and note 2. 
   * @return reportingPeriod
   **/
  @Schema(required = true, description = "Specifies the periodicity at which the producer will report to the API consumer about performance information. The unit shall be seconds. See note 1 and note 2. ")
      @NotNull
