 ...
 */
package com.ubiqube.etsi.mano.v431.vnfm.controller.em.vnffm;
...
@RestController
public class AlarmSubscriptions431Sol002Controller implements AlarmSubscriptions431Sol002Api, SubscriptionLinkable431Vnfm {
	...
	public AlarmSubscriptions431Sol002Controller(final FaultMngtSubscriptionsFrontController faultMngtSubscriptionsFrontController, final FmSubscription431Mapping mapper) {
	...
	public ResponseEntity<List<FmSubscription>> subscriptionsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return faultMngtSubscriptionsFrontController.search(requestParams, x -> mapper.map(x, FmNotificationsFilter.class), AlarmSubscriptions431Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<FmSubscription> subscriptionsPost(@Valid final FmSubscriptionRequest body) {
		...
		return faultMngtSubscriptionsFrontController.create(req, x -> mapper.map(x, FmNotificationsFilter.class), AlarmSubscriptions431Sol002Api.class, AlarmSubscriptions431Sol002Controller::makeLinks, AlarmSubscriptions431Sol002Controller::makeSelf);
	}
	...
	public ResponseEntity<FmSubscription> subscriptionsSubscriptionIdGet(final String subscriptionId) {
		return faultMngtSubscriptionsFrontController.findById(subscriptionId, x -> mapper.map(x, FmNotificationsFilter.class), AlarmSubscriptions431Sol002Controller::makeLinks);
	}
	...
	public String makeSelfLink(final String id) {
		return linkTo(methodOn(AlarmSubscriptions431Sol002Api.class).subscriptionsSubscriptionIdGet(id)).withSelfRel().getHref();
	}
