...
import com.ubiqube.etsi.mano.service.mapping.subscription.FmSubscription431Mapping;
...
public class AlarmSubscriptions431Sol002Controller implements AlarmSubscriptions431Sol002Api, SubscriptionLinkable431Vnfm {
	...
	public ResponseEntity<FmSubscription> subscriptionsPost(@Valid final FmSubscriptionRequest body) {
		...
		return faultMngtSubscriptionsFrontController.create(req, x -> mapper.map(x, FmSubscription.class), AlarmSubscriptions431Sol002Api.class, AlarmSubscriptions431Sol002Controller::makeLinks, AlarmSubscriptions431Sol002Controller::makeSelf);
	}
