...
import com.ubiqube.etsi.mano.service.mapping.PmJob431Mapping;
...
public class PmJobs431Sol002Controller implements PmJobs431Sol002Api {
	...
	public PmJobs431Sol002Controller(final VnfmPmGenericFrontController vnfmPmGenericFrontController, final PmJob431Mapping mapper) {
	...
	public ResponseEntity<String> pmJobsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return vnfmPmGenericFrontController.search(requestParams, x -> mapper.map(x), PmJobs431Sol002Controller::makeLinks, PmJob.class);
	}
	...
	public ResponseEntity<PmJob> pmJobsPmJobIdGet(final String pmJobId) {
		return vnfmPmGenericFrontController.findById(UUID.fromString(pmJobId), x -> mapper.map(x), PmJobs431Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<PmJob> pmJobsPost(@Valid final CreatePmJobRequest createPmJobRequest) {
		...
		return vnfmPmGenericFrontController.pmJobsPost(req, x -> mapper.map(x), PmJobs431Sol002Controller::makeLinks, PmJobs431Sol002Controller::makeSelf);
	}
