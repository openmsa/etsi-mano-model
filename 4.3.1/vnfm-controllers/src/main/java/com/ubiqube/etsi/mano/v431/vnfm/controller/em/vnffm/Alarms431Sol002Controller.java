...
import com.ubiqube.etsi.mano.v431.model.em.vnffm.PerceivedSeverityRequest;
...
public class Alarms431Sol002Controller implements Alarms431Sol002Api {
	...
	public Alarms431Sol002Controller(final AlarmFrontController alarmFrontController, final Alarm431Mapping mapper) {
	...
	public ResponseEntity<Alarm> alarmsAlarmIdGet(final String alarmId) {
		return alarmFrontController.findById(alarmId, mapper::map, Alarms431Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<String> alarmsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return alarmFrontController.search(requestParams, mapper::map, Alarms431Sol002Controller::makeLinks, Alarm.class);
	}
