...
public class VnfInstances331Sol003Controller implements VnfInstances331Sol003Api {
	...
	public VnfInstances331Sol003Controller(final VnfInstanceGenericFrontController frontController, final VnfInstance331Mapping mapper, final VnfInstantiate331Mapping vnfInstantiate361Mapping, final VnfInstanceRequest331Mapping vnfInstanceRequest361Mapping) {
	...
	public ResponseEntity<String> vnfInstancesGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return frontController.search(requestParams, x -> mapper.map(x), nextpageOpaqueMarker, VnfInstances331Sol003Controller::makeLinks, VnfInstance.class);
	}
	...
	public ResponseEntity<VnfInstance> vnfInstancesVnfInstanceIdGet(final String vnfInstanceId) {
		return frontController.findById(getSafeUUID(vnfInstanceId), x -> mapper.map(x), VnfInstances331Sol003Controller::makeLinks, "");
	}
