 ...
 */
package com.ubiqube.etsi.mano.v331.vnfm.controller.vnfm.vnffm;
...
public class VnfFmSubscriptions331Sol003Controller implements VnfFmSubscriptions331Sol003Api, SubscriptionLinkable331Vnfm {
	...
	public VnfFmSubscriptions331Sol003Controller(final FaultMngtSubscriptionsFrontController faultMngtSubscriptionsFrontController, final FmSubscription331Mapping mapper) {
	...
	public ResponseEntity<List<FmSubscription>> subscriptionsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return faultMngtSubscriptionsFrontController.search(requestParams, x -> mapper.map(x, FmNotificationsFilter.class), VnfFmSubscriptions331Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<FmSubscription> subscriptionsPost(@Valid final FmSubscriptionRequest body) {
		...
		return faultMngtSubscriptionsFrontController.create(req, x -> mapper.map(x, FmNotificationsFilter.class), VnfFmSubscriptions331Sol003Api.class, VnfFmSubscriptions331Sol003Controller::makeLinks, VnfFmSubscriptions331Sol003Controller::makeSelf);
	}
	...
	public ResponseEntity<FmSubscription> subscriptionsSubscriptionIdGet(final String subscriptionId) {
		return faultMngtSubscriptionsFrontController.findById(subscriptionId, x -> mapper.map(x, FmNotificationsFilter.class), VnfFmSubscriptions331Sol003Controller::makeLinks);
	}
	...
	public String makeSelfLink(final String id) {
		return linkTo(methodOn(VnfFmSubscriptions331Sol003Api.class).subscriptionsSubscriptionIdGet(id)).withSelfRel().getHref();
	}
