...
public class Alarms331Sol003Controller implements Alarms331Sol003Api {
	...
	public Alarms331Sol003Controller(final AlarmFrontController alarmFrontController, final Alarm331Mapping mapper) {
	...
	public ResponseEntity<Alarm> alarmsAlarmIdGet(final String alarmId) {
		return alarmFrontController.findById(alarmId, x -> mapper.map(x), Alarms331Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<String> alarmsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return alarmFrontController.search(requestParams, x -> mapper.map(x), Alarms331Sol003Controller::makeLinks, Alarm.class);
	}
