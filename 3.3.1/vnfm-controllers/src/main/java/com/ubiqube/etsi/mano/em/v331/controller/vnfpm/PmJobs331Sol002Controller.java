...
public class PmJobs331Sol002Controller implements PmJobs331Sol002Api {
	...
	public PmJobs331Sol002Controller(final VnfmPmGenericFrontController vnfmPmGenericFrontController, final MapperFacade mapper) {
	...
	public ResponseEntity<String> pmJobsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return vnfmPmGenericFrontController.search(requestParams, x -> mapper.map(x, PmJob.class), PmJobs331Sol002Controller::makeLinks, PmJob.class);
	}
	...
	public ResponseEntity<PmJob> pmJobsPmJobIdGet(final String pmJobIdn) {
		return vnfmPmGenericFrontController.findById(UUID.fromString(pmJobIdn), x -> mapper.map(x, PmJob.class), PmJobs331Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<PmJob> pmJobsPost(@Valid final CreatePmJobRequest createPmJobRequest) {
		...
		return vnfmPmGenericFrontController.pmJobsPost(req, x -> mapper.map(x, PmJob.class), PmJobs331Sol002Controller::makeLinks, PmJobs331Sol002Controller::makeSelf);
	}
