package com.ubiqube.etsi.mano.v331.model.vnfm.vnflcm;
...
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.AffectedExtLinkPort;
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.AffectedVirtualLink;
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.AffectedVirtualStorage;
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.AffectedVnfc;
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.ExtVirtualLinkInfo;
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.LccnLinks;
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.LcmOpOccNotificationVerbosityType;
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.LcmOperationStateType;
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.LcmOperationType;
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.ModificationsTriggeredByVnfPkgChange;
import com.ubiqube.etsi.mano.v331.model.em.vnflcm.VnfInfoModifications;
 ...
 * lifecycle, includingwhich represents an occurrence of one the following LCM
 ...
 * instance\&quot; resource * Creation of a VNF snapshot * Reversion of the VNF
 * instance to a VNF snapshot. Clause 5.6.2 defines the states and state
...
public class VnfLcmOperationOccurrenceNotification {
	 ...
	 * \"RESULT\", the \"verbosity\" attribute is set to \"FULL\" and the operation
	 * has performed any resource modification. Shall be absent otherwise. This
	 * attribute contains information about the cumulative changes to virtualised
	 * resources that were performed so far by the VNF LCM operation occurrence and
	 * by any of the error handling procedures for that operation occurrence.
	 *
	 ...
	 * operation occurrence. For a particular affected VL, there shall be as many
	 * \"AffectedVirtualLink\" entries as needed for signalling the different types
	 * of changes, i.e., one per virtual link and change type. For instance, in the
	 * case of signaling affected VL instances involving the addition of a
	 ...
	 * \"AffectedVirtualLink\" structure equal to \"ADDED\", and another
	 * \"AffectedVirtualLink\" entry signals the addition of VNF link ports of the
	 * VL by using the \"changeType\" equal to \"LINK_PORT_ADDED\".
	 *
