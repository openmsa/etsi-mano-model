...
public class ManoService {
	...
	@JsonProperty("_links")
	private ManoServiceLinks links = null;
	 ...
	 * referred. NOTE: A cardinality greater than one supports having different
	 * interface versions or apiEndpoints to be used for accessing the same instance
	 * of a NFV-MANO service.
	 *
	...
	public ManoService links(final ManoServiceLinks _links) {
		this.links = _links;
		return this;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.id, manoService.id) &&
				...
				Objects.equals(this.links, manoService.links);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, name, description, manoServiceInterfaceIds, links);
	}
