...
public class PerformanceReportPerformanceValues   {
   ...
   * @return value
   **/
  @Schema(requiredMode = RequiredMode.REQUIRED, description = "Value of the metric collected. The type of this attribute shall correspond to  the related \"Measurement Unit\" as defined in clause 8.4 of ETSI GS NFV-IFA 031. ")
      @NotNull
