 ...
 */
package com.ubiqube.etsi.mano.v361.services.mapping.nslcm;
...
import com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.ConnectivityServiceEndpointInfo;
...
import com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.LocationConstraintsCivicAddressElement;
import com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.MscsEndpointInfo;
import com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.ParamsForNestedNs;
import com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.ScaleNsRequest;
import com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.SiteToWanLayer2ProtocolDataForwardingConfig;
import com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.SiteToWanLayer3ProtocolDataRoutingInfoBgpRouting;
import com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.UpdateNsRequest;

import jakarta.validation.Valid;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface NsRequest331Mapping {

	@Mapping(target = "id", ignore = true)
	NsHeal map(HealNsRequest o);

	@Mapping(target = "id", ignore = true)
	HealVnfData map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.HealVnfData o);
	...
	@Mapping(target = "id", ignore = true)
	ParamsForVnf map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.ParamsForVnf o);

	@Mapping(target = "id", ignore = true)
	NestedNsInstanceData map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.NestedNsInstanceData o);

	@Mapping(target = "id", ignore = true)
	VnfInstanceData map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.VnfInstanceData o);
	...
	ScaleNsData map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.ScaleNsData o);

	@Mapping(target = "id", ignore = true)
	ScaleNsByStepsData map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.ScaleNsByStepsData o);

	@Mapping(target = "id", ignore = true)
	ScaleNsToLevelData map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.ScaleNsToLevelData o);

	@Mapping(target = "id", ignore = true)
	@Mapping(target = "scaleToLevel", ignore = true)
	@Mapping(target = "vnfdId", ignore = true)
	NsScaleInfo map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.NsScaleInfo o);

	@Mapping(target = "id", ignore = true)
	ScaleVnfData map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.ScaleVnfData o);

	@Mapping(target = "id", ignore = true)
	ScaleByStepData map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.ScaleByStepData o);

	@Mapping(target = "id", ignore = true)
	ScaleToLevelData map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.ScaleToLevelData o);

	@Mapping(target = "id", ignore = true)
	@Mapping(target = "numberOfSteps", ignore = true)
	@Mapping(target = "scaleType", ignore = true)
	VnfScaleInfo map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.VnfScaleInfo o);

	@Mapping(target = "id", ignore = true)
	VnfLocationConstraint map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.VnfLocationConstraint o);

	// Look at RFC 7946 for geo json encoding.
	@Mapping(target = "id", ignore = true)
	@Mapping(target = "area", ignore = true)
	LocationConstraints map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.LocationConstraints o);
	...
	UpdateTypeEnum map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.UpdateNsRequest.UpdateTypeEnum o);

	NfpData map(com.ubiqube.etsi.mano.v331.model.nfvo.nslcm.NfpData value);
