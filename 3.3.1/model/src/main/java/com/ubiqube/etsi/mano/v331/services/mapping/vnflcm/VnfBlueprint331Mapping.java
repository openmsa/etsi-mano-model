 ...
 */
package com.ubiqube.etsi.mano.v331.services.mapping.vnflcm;
...
import com.ubiqube.etsi.mano.v331.services.mapping.Connectivity331Mapping;
import com.ubiqube.etsi.mano.v331.services.mapping.VimConnectionInfo331Mapping;

@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface VnfBlueprint331Mapping extends StringToUriMapping, Connectivity331Mapping, VimConnectionInfo331Mapping {
	...
	@ValueMapping(source = "LINK_PORT_ADDED", target = "ADDED")
	@ValueMapping(source = "LINK_PORT_REMOVED", target = "REMOVED")
	@ValueMapping(source = "MODIFIED", target = MappingConstants.THROW_EXCEPTION)
