...
public interface VnfPkgInfo331Mapping extends StringToUriMapping {
	...
	Checksum map(com.ubiqube.etsi.mano.v331.model.nfvo.vnfsnapshotpkgm.Checksum o);
	...
	@Mapping(target = "sha256", ignore = true)
	@Mapping(target = "sha512", ignore = true)
	PkgChecksum mapToPkgChecksum(com.ubiqube.etsi.mano.v331.model.nfvo.vnfsnapshotpkgm.Checksum o);
