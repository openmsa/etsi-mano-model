...
import com.ubiqube.etsi.mano.v331.model.nfvem.nfvmanologm.LoggingJobConfigSecurityConfLogFileEncryption;
...
public interface Logm331Mapping extends StringToUriMapping {
	...
	CompileLogRequest map(com.ubiqube.etsi.mano.v331.model.nfvem.nfvmanologm.@Valid CompileLogRequest body);
	...
	CreateLoggingJobRequest map(com.ubiqube.etsi.mano.v331.model.nfvem.nfvmanologm.CreateLoggingJobRequest body);

	@Mapping(target = "id", ignore = true)
	LogFileEncryption map(LoggingJobConfigSecurityConfLogFileEncryption o);

	@Mapping(target = "id", ignore = true)
	LoggingJobCriteria map(com.ubiqube.etsi.mano.v331.model.nfvem.nfvmanologm.LoggingJobCriteria o);

	@Mapping(target = "id", ignore = true)
	LoggingJobMessagesCriteria map(com.ubiqube.etsi.mano.v331.model.nfvem.nfvmanologm.LoggingJobMessagesCriteria o);

	@Mapping(target = "id", ignore = true)
	MatchingPatterns map(LoggingJobMessagesCriteriaMatchingPatterns o);

	@Mapping(target = "id", ignore = true)
	LoggingJobSystemCriteria map(com.ubiqube.etsi.mano.v331.model.nfvem.nfvmanologm.LoggingJobSystemCriteria o);
}
