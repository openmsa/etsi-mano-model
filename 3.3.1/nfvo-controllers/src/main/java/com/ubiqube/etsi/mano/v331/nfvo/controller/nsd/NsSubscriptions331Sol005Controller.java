 ...
 */
package com.ubiqube.etsi.mano.v331.nfvo.controller.nsd;
...
import com.ubiqube.etsi.mano.v331.model.nfvo.nsd.NsdmNotificationsFilter;
import com.ubiqube.etsi.mano.v331.model.nfvo.nsd.NsdmSubscription;
 ...
 */
@RestController
public class NsSubscriptions331Sol005Controller implements NsSubscriptions331Sol005Api, SubscriptionLinkable331Nfvo {
	private final NsdSubscriptionFrontController nsdSubscriptionFrontController;
	private final NsdmSubscription331Mapping mapper;

	public NsSubscriptions331Sol005Controller(final NsdSubscriptionFrontController nsdSubscriptionFrontController, final NsdmSubscription331Mapping mapper) {
	...
	public ResponseEntity<List<NsdmSubscription>> subscriptionsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return nsdSubscriptionFrontController.search(requestParams, x -> mapper.map(x, NsdmNotificationsFilter.class), NsSubscriptions331Sol005Controller::makeLink);
	}
	...
	public ResponseEntity<NsdmSubscription> subscriptionsPost(final NsdmSubscriptionRequest body) {
		...
		return nsdSubscriptionFrontController.create(req, x -> mapper.map(x, NsdmNotificationsFilter.class), NsSubscriptions331Sol005Api.class, NsSubscriptions331Sol005Controller::makeLink, NsSubscriptions331Sol005Controller::getSelfLink);
	}
	...
	public ResponseEntity<NsdmSubscription> subscriptionsSubscriptionIdGet(final String subscriptionId) {
		return nsdSubscriptionFrontController.findById(subscriptionId, x -> mapper.map(x, NsdmNotificationsFilter.class), NsSubscriptions331Sol005Controller::makeLink);
	}
	...
	public String makeSelfLink(final String id) {
		return linkTo(methodOn(NsSubscriptions331Sol005Api.class).subscriptionsSubscriptionIdGet(id)).withSelfRel().getHref();
	}
