...
public interface VnfIdentifierCreationNotification451Sol002Api {
	...
	ResponseEntity<Void> vnfIdentifierCreationNotificationPost(
			@Parameter(in = ParameterIn.DEFAULT, description = "A notification about lifecycle changes triggered by a VNF LCM operation occurrence.", required = true, schema = @Schema()) @Valid @RequestBody final VnfIdentifierCreationNotification body);
}
