...
@RequestMapping(value = "/sol002/vnflcm/v2", headers = { "Version=2.12.0" })
@RolesAllowed({ "ROLE_EM" })
@Validated
public interface VnfLcmOperationOccurrenceNotification451Sol002Api {

	Logger log = LoggerFactory.getLogger(VnfLcmOperationOccurrenceNotification451Sol002Api.class);
