...
public interface URIIsProvidedByTheClientWhenCreatingTheSubscriptionVnfPackageOnboardingNotificationApi {
	...
	@Operation(summary = "", description = "The GET method allows the API producer to test the notification endpoint that is provided by the API consumer, e.g. during subscription. See clause 10.4.9.3.2. ", tags = {})
	@ApiResponses(value = {
