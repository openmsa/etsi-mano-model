...
@RequestMapping(value = "/sol002/vnfind/v1", headers = { "Version=1.12.0" })
@RolesAllowed({ "ROLE_EM" })
@Validated
public interface SupportedIndicatorsChangeNotification451Sol002Api {

	Logger log = LoggerFactory.getLogger(SupportedIndicatorsChangeNotification451Sol002Api.class);
