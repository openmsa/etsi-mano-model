...
import com.ubiqube.etsi.mano.em.v451.model.vnfpm.CreatePmJobRequest;
import com.ubiqube.etsi.mano.em.v451.model.vnfpm.PerformanceReport;
import com.ubiqube.etsi.mano.em.v451.model.vnfpm.PmJob;
import com.ubiqube.etsi.mano.em.v451.model.vnfpm.PmJobModifications;
...
@RequestMapping(value = "/sol002/vnffm/v2", headers = { "Version=2.12.0" })
@RolesAllowed({ "ROLE_EM" })
@Validated
public interface PmJobs451Sol002Api {

	Logger log = LoggerFactory.getLogger(PmJobs451Sol002Api.class);
	...
	@Operation(summary = "", description = "The API consumer can use this method to retrieve information about PM jobs. See clause 6.4.2.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about zero or more PM jobs was queried successfully. The response body shall contain in an array the representations of zero or more PM jobs, as defined in clause 6.5.2.7. If the \"filter\" URI parameter or one of the \"all_fields\", \"fields\" (if supported),  \"exclude_fields\" (if supported) or \"exclude_default\" URI parameters was supplied in  the request, the data in the response body shall have been transformed according to  the rules specified in clauses 5.2.2 and 5.3.2 of ETSI GS NFV-SOL 013, respectively. If the VNFM supports alternative 2 (paging) according to clause 5.4.2.1 of  ETSI GS NFV-SOL 013for this resource, inclusion of the Link HTTP header in this  response shall follow the provisions in clause 5.4.2.3 of ETSI GS NFV-SOL 013. ", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = PmJob.class)))),
	...
	default ResponseEntity<List<PmJob>> pmJobsGet(
			...
			@Parameter(in = ParameterIn.QUERY, description = "Attribute-based filtering expression according to clause 5.2 of ETSI GS NFV-SOL 013 [6]. The VNFM shall support receiving this parameter as part of the URI query string. The API consumer may supply this parameter. All attribute names that appear in the PmJob and in data types referenced from it shall be supported by the VNFM in the filter expression. ", schema = @Schema()) @Valid @RequestParam(value = "filter", required = false) final String filter,
			@Parameter(in = ParameterIn.QUERY, description = "Include all complex attributes in the response. See clause 5.3 of ETSI GS NFV-SOL 013 [6] for details. The VNFM shall support this parameter. ", schema = @Schema()) @Valid @RequestParam(value = "all_fields", required = false) final String allFields,
			@Parameter(in = ParameterIn.QUERY, description = "Complex attributes to be included into the response. See clause 5.3 of ETSI GS NFV-SOL 013 [6] for details. The VNFM should support this parameter. ", schema = @Schema()) @Valid @RequestParam(value = "fields", required = false) final String fields,

			@Parameter(in = ParameterIn.QUERY, description = "Complex attributes to be excluded from the response. See clause 5.3 of ETSI GS NFV-SOL 013 [6] for details. The VNFM should support this parameter. ", schema = @Schema()) @Valid @RequestParam(value = "exclude_fields", required = false) final String excludeFields,
			@Parameter(in = ParameterIn.QUERY, description = "Indicates to exclude the following complex attributes from the response. See clause 5.3 of ETSI GS NFV-SOL 013 [6] for details. The VNFM shall support this parameter. The following attributes shall be excluded from the PmJob structure in the response body if this parameter is provided, or none of the parameters \"all_fields\", \"fields\", \"exclude_fields\", \"exclude_default\" are provided:   - reports ", schema = @Schema()) @Valid @RequestParam(value = "exclude_default", required = false) final String excludeDefault,
	...
	@Operation(summary = "", description = "This method terminates an individual PM job. See clause 6.4.3.3.5. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<Void> pmJobsPmJobIdDelete(
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM job. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new PM job resource. It can also be retrieved from the \"id\" attribute in the message content of that response. ", required = true, schema = @Schema()) @PathVariable("pmJobId") final String pmJobId,
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
		} else {
	...
	@Operation(summary = "", description = "The API consumer can use this method for reading an individual PM job. See clause 6.4.3.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about an individual PM job has been  ueried successfully. The response body shall contain a representation of the \"Individual PM job\" resource. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PmJob.class))),
	...
	default ResponseEntity<PmJob> pmJobsPmJobIdGet(
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM job. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new PM job resource. It can also be retrieved from the \"id\" attribute in the message content of that response. ", required = true, schema = @Schema()) @PathVariable("pmJobId") final String pmJobId,
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
	...
	@Operation(summary = "", description = "This method allows to modify an \"individual PM job\" resource. See clause 6.4.3.3.4. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when the request has been processed successfully. The response body shall contain a data structure of type \"PmJobModifications\". ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PmJobModifications.class))),
	...
	default ResponseEntity<PmJobModifications> pmJobsPmJobIdPatch(
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM job. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new PM job resource. It can also be retrieved from the \"id\" attribute in the message content of that response. ", required = true, schema = @Schema()) @PathVariable("pmJobId") final String pmJobId,
	...
	default ResponseEntity<PerformanceReport> pmJobsPmJobIdReportsReportIdGet(
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM job. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new PM job resource. It can also be retrieved from the \"id\" attribute in the message content of that response. ", required = true, schema = @Schema()) @PathVariable("pmJobId") final String pmJobId,
	...
	@Operation(summary = "", description = "The POST method creates a PM job. See clause 6.4.2.3.1. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED Shall be returned when the PM job has been created successfully.  The response body shall contain a representation of the created  PM job resource. The HTTP response shall include a \"Location\" HTTP header that points to the created \"Individual PM job\" resource. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PmJob.class))),
	...
	default ResponseEntity<PmJob> pmJobsPost(
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType,
			@Parameter(in = ParameterIn.DEFAULT, description = "The VNF creation parameters", required = true, schema = @Schema()) @Valid @RequestBody final CreatePmJobRequest body,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
