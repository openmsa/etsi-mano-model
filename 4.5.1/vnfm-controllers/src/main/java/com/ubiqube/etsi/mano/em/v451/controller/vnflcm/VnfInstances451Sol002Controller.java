...
public class VnfInstances451Sol002Controller implements VnfInstances451Sol002Api {
	...
	public VnfInstances451Sol002Controller(final VnfInstanceGenericFrontController frontController, final MapperFacade mapper) {
	...
	public ResponseEntity<VnfInstance> vnfInstancesVnfInstanceIdGet(final String vnfInstanceId) {
		return frontController.findById(getSafeUUID(vnfInstanceId), x -> mapper.map(x, VnfInstance.class), VnfInstances451Sol002Controller::makeLinks, "");
	}
