 ...
 */
package com.ubiqube.etsi.mano.em.v451.controller.vnflcm;
...
import com.ubiqube.etsi.mano.service.mapping.VnfInstanceMapping;
import com.ubiqube.etsi.mano.service.mapping.vnflcm.ChangeExtVnfConnRequestMapping;
import com.ubiqube.etsi.mano.service.mapping.vnflcm.VnfInstantiateMapping;
import com.ubiqube.etsi.mano.service.mapping.vnflcm.VnfOperateRequestMapping;
import com.ubiqube.etsi.mano.service.mapping.vnflcm.VnfScaleRequestMapping;
...
public class VnfInstances451Sol002Controller implements VnfInstances451Sol002Api {
	...
	private final ChangeExtVnfConnRequestMapping changeExtVnfConnRequestMapping;
	private final VnfInstanceMapping vnfInstanceMapping;
	private final VnfInstantiateMapping vnfInstantiateMapping;
	private final VnfOperateRequestMapping vnfOperateRequestMapping;
	private final VnfScaleRequestMapping vnfScaleRequestMapping;

	public VnfInstances451Sol002Controller(final VnfInstanceGenericFrontController frontController, final ChangeExtVnfConnRequestMapping changeExtVnfConnRequestMapping, final VnfInstanceMapping vnfInstanceMapping, final VnfInstantiateMapping vnfInstantiateMapping, final VnfOperateRequestMapping vnfOperateRequestMapping, final VnfScaleRequestMapping vnfScaleRequestMapping) {
	...
	public ResponseEntity<String> vnfInstancesGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return frontController.search(requestParams, VnfInstance.class, nextpageOpaqueMarker, VnfInstances451Sol002Controller::makeLinks);
	}

	@Override
	public ResponseEntity<VnfInstance> vnfInstancesPost(@Valid final CreateVnfRequest body) {
		return frontController.create(body.getVnfdId(), body.getVnfInstanceName(), body.getVnfInstanceDescription(), vnfInstanceMapping::map,
				VnfInstances451Sol002Controller::makeLinks, "");
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdChangeFlavourPost(final String vnfInstanceId, @Valid final ChangeVnfFlavourRequest body) {
		return frontController.changeFlavour(getSafeUUID(vnfInstanceId), body, VnfInstances451Sol002Controller::getLcmLink);
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdChangeVnfpkgPost(final String vnfInstanceId, @Valid final ChangeCurrentVnfPkgRequest body) {
		return frontController.changeVnfPkg(getSafeUUID(vnfInstanceId), body, VnfInstances451Sol002Controller::getLcmLink);
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdCreateSnapshotPost(final String vnfInstanceId, @Valid final CreateVnfSnapshotRequest body) {
		return frontController.createSnapshot(getSafeUUID(vnfInstanceId), body, VnfInstances451Sol002Controller::getLcmLink);
	}
	...
	public ResponseEntity<VnfInstance> vnfInstancesVnfInstanceIdGet(final String vnfInstanceId) {
		return frontController.findById(getSafeUUID(vnfInstanceId), vnfInstanceMapping::map, VnfInstances451Sol002Controller::makeLinks, "");
	}

	@Override
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdHealPost(final String vnfInstanceId, @Valid final HealVnfRequest body) {
		return frontController.heal(getSafeUUID(vnfInstanceId), body.getCause(), new HashMap<>(), VnfInstances451Sol002Controller::getLcmLink);
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdInstantiatePost(final String vnfInstanceId, @Valid final InstantiateVnfRequest body) {
		...
		return frontController.instantiate(getSafeUUID(vnfInstanceId), req, VnfInstances451Sol002Controller::getLcmLink);
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdOperatePost(final String vnfInstanceId, @Valid final OperateVnfRequest body) {
		...
		return frontController.operate(getSafeUUID(vnfInstanceId), req, VnfInstances451Sol002Controller::getLcmLink);
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdPatch(final String vnfInstanceId, @Valid final String body, final OffsetDateTime ifUnmodifiedSince, final String ifMatch) {
		return frontController.modify(getSafeUUID(vnfInstanceId), body, ifMatch, VnfInstances451Sol002Controller::getInstanceLink);
	}
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdTerminatePost(final String vnfInstanceId, @Valid final TerminateVnfRequest body) {
		return frontController.terminate(getSafeUUID(vnfInstanceId), CancelModeTypeEnum.valueOf(body.getTerminationType().toString()), body.getGracefulTerminationTimeout(), VnfInstances451Sol002Controller::getLcmLink);
	}

	private static String getLcmLink(final VnfBlueprint vnfblueprint) {
		return linkTo(methodOn(VnfLcmOpOccs451Sol002Api.class).vnfLcmOpOccsVnfLcmOpOccIdGet(vnfblueprint.getId().toString())).withSelfRel().getHref();
	}

	private static String getInstanceLink(final com.ubiqube.etsi.mano.dao.mano.VnfInstance vnfInstance) {
		return linkTo(methodOn(VnfInstances451Sol002Api.class).vnfInstancesVnfInstanceIdGet(vnfInstance.getId().toString())).withSelfRel().getHref();
	}

	private static void makeLinks(final VnfInstance vnfInstance) {
		final String id = vnfInstance.getId();
		final String hrefScaleToLevel = linkTo(methodOn(VnfInstances451Sol002Api.class).vnfInstancesVnfInstanceIdScaleToLevelPost(id, null)).withSelfRel().getHref();
		final String hrefScale = linkTo(methodOn(VnfInstances451Sol002Api.class).vnfInstancesVnfInstanceIdScalePost(id, null)).withSelfRel().getHref();
		final String hrefOperate = linkTo(methodOn(VnfInstances451Sol002Api.class).vnfInstancesVnfInstanceIdOperatePost(id, null)).withSelfRel().getHref();
		final String hrefInstanciate = linkTo(methodOn(VnfInstances451Sol002Api.class).vnfInstancesVnfInstanceIdInstantiatePost(id, null)).withSelfRel().getHref();
		final String hrefIndicators = "";
		final String hrefHeal = linkTo(methodOn(VnfInstances451Sol002Api.class).vnfInstancesVnfInstanceIdHealPost(id, null)).withSelfRel().getHref();
		final String hrefChangeFlavor = linkTo(methodOn(VnfInstances451Sol002Api.class).vnfInstancesVnfInstanceIdChangeFlavourPost(id, null)).withSelfRel().getHref();
		final String hrefChangeExtConn = linkTo(methodOn(VnfInstances451Sol002Api.class).vnfInstancesVnfInstanceIdChangeExtConnPost(id, null)).withSelfRel().getHref();
		final String hrefSelf = linkTo(methodOn(VnfInstances451Sol002Api.class).vnfInstancesVnfInstanceIdGet(id)).withSelfRel().getHref();
		final String hrefTerminate = linkTo(methodOn(VnfInstances451Sol002Api.class).vnfInstancesVnfInstanceIdTerminatePost(id, null)).withSelfRel().getHref();
