...
@Validated
public interface VnfIndicatorValueChangeNotification451Sol002Api {

	Logger log = LoggerFactory.getLogger(VnfIndicatorValueChangeNotification451Sol002Api.class);
