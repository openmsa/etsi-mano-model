...
public interface VnfIdentifierDeletionNotification451Sol002Api {
	...
	ResponseEntity<Void> vnfIdentifierDeletionNotificationPost(
			@Parameter(in = ParameterIn.DEFAULT, description = "A notification about the deletion of a VNF identifier and the related Individual VNF instance resource.", required = true, schema = @Schema()) @Valid @RequestBody final VnfIdentifierCreationNotification body);
}
