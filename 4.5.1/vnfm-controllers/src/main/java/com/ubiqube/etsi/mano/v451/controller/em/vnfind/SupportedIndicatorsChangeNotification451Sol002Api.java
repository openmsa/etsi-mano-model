...
public interface SupportedIndicatorsChangeNotification451Sol002Api {
	...
	ResponseEntity<Void> indicatorsChangeNotificationGet();
	...
	ResponseEntity<Void> indicatorsChangeNotificationPost(
			@Parameter(in = ParameterIn.DEFAULT, description = "A notification about changes of the set of supported indicators.", required = true, schema = @Schema()) @Valid @RequestBody final SupportedIndicatorsChangeNotification body);
}
