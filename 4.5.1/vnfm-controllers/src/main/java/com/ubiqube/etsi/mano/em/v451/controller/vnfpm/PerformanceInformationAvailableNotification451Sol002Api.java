...
@Validated
public interface PerformanceInformationAvailableNotification451Sol002Api {

	Logger log = LoggerFactory.getLogger(PerformanceInformationAvailableNotification451Sol002Api.class);
