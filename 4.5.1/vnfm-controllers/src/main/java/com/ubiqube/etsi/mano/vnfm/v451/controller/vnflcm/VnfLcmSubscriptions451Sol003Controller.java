...
public class VnfLcmSubscriptions451Sol003Controller implements VnfLcmSubscriptions451Sol003Api, SubscriptionLinkable451Vnfm {
	...
	public VnfLcmSubscriptions451Sol003Controller(final VnfLcmSubscriptionFrontController frontController, final MapperFacade mapper) {
	...
	public ResponseEntity<LccnSubscription> subscriptionsPost(@Valid final LccnSubscriptionRequest body) {
		...
		return frontController.create(req, x -> mapper.map(x, LccnSubscription.class), VnfLcmSubscriptions451Sol003Api.class, VnfLcmSubscriptions451Sol003Controller::makeLinks, VnfLcmSubscriptions451Sol003Controller::getSelfLink);
	}
