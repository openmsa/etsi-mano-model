 ...
 */
package com.ubiqube.etsi.mano.v451.controller.vnfm.vnflcm;
...
public class VnfLcmOpOccs451Sol003Controller implements VnfLcmOpOccs451Sol003Api {
	...
	public ResponseEntity<String> vnfLcmOpOccsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return frontController.search(requestParams, vnfLcmOpOcc451Mapping::map, VnfLcmOpOccs451Sol003Controller::makeLinks, VnfLcmOpOcc.class);
	}
	...
	public ResponseEntity<VnfLcmOpOcc> vnfLcmOpOccsVnfLcmOpOccIdGet(final String vnfLcmOpOccId) {
		return frontController.lcmOpOccFindById(vnfLcmClassMaping451, UUID.fromString(vnfLcmOpOccId), VnfLcmOpOccs451Sol003Controller::makeLinks, VnfLcmOpOccs451Sol003Controller::setOperationParams);
	}
