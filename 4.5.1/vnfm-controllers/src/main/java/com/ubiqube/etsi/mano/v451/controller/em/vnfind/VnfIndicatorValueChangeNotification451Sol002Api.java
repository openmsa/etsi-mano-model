...
public interface VnfIndicatorValueChangeNotification451Sol002Api {
	...
	ResponseEntity<Void> indicatorValueChangeNotificationGet();
	...
	ResponseEntity<Void> indicatorValueChangeNotificationPost(
			@Parameter(in = ParameterIn.DEFAULT, description = "A notification about VNF indicator value changes.", required = true, schema = @Schema()) @Valid @RequestBody final VnfIndicatorValueChangeNotification body);
}
