...
@RequestMapping(value = "/sol003/vnfind/v1", headers = { "Version=1.12.0" })
@RolesAllowed({ "ROLE_VNFM" })
@Validated
public interface VnfIndicatorValueChangeNotification451Sol003Api {

	Logger log = LoggerFactory.getLogger(VnfIndicatorValueChangeNotification451Sol003Api.class);
