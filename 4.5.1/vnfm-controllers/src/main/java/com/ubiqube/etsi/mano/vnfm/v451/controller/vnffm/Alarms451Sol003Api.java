...
@Validated
public interface Alarms451Sol003Api {

	Logger log = LoggerFactory.getLogger(Alarms451Sol003Api.class);
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when the request has been accepted and completed. The response body shall contain attribute modifications for an \"Individual alarm\" resource (see clause 7.5.2.4). ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AlarmModifications.class))),
