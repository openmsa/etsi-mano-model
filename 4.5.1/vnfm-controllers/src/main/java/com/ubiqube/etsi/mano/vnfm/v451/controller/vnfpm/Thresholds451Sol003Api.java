...
import com.ubiqube.etsi.mano.em.v451.model.vnfpm.CreateThresholdRequest;
import com.ubiqube.etsi.mano.em.v451.model.vnfpm.Threshold;
import com.ubiqube.etsi.mano.em.v451.model.vnfpm.ThresholdModifications;
...
public interface Thresholds451Sol003Api {
	...
	Logger log = LoggerFactory.getLogger(Thresholds451Sol003Api.class);
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "422", description = "422 Unprocessable Content  Shall be returned upon the following error: The content type of the message content is supported and the message content of a request contains syntactically correct data but the data cannot be processed. The general cause for this error and its handling is specified in clause 6.4 of ETSI GS NFV-SOL 013 [8], including rules for the presence of the response body. Specifically in case of this resource, the response code 422 shall also be returned if the VNFM has tested the Notification endpoint as described in clause 6.4.9.3.2 and the test has failed. In this case, the \"detail\" attribute in the \"ProblemDetails\" structure shall convey more information about the error ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProblemDetails.class))),
	...
	default ResponseEntity<Void> thresholdsThresholdIdDelete(@Parameter(in = ParameterIn.PATH, description = "Identifier of the threshold. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new \"Individual threshold\" resource. It can also be retrieved from the \"id\" attribute in the message content of that response. ", required = true, schema = @Schema()) @PathVariable("thresholdId") final String thresholdId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
		} else {
			log.warn("ObjectMapper or HttpServletRequest not configured in default ThresholdsApi interface so no example is generated");
		}
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when information about an individual threshold has been read successfully. The response body shall contain a representation of the threshold, as defined in clause 6.5.2.9. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Threshold.class))),
