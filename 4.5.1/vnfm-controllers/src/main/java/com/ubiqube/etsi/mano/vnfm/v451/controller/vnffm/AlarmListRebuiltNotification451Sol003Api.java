...
@RequestMapping(value = "/sol003/vnffm/v1", headers = { "Version=1.12.0" })
@RolesAllowed({ "ROLE_VNFM" })
@Validated
public interface AlarmListRebuiltNotification451Sol003Api {

	Logger log = LoggerFactory.getLogger(AlarmListRebuiltNotification451Sol003Api.class);
