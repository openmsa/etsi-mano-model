...
@Validated
public interface PerformanceInformationAvailableNotification451Sol005Api {

	Logger log = LoggerFactory.getLogger(PerformanceInformationAvailableNotification451Sol005Api.class);
