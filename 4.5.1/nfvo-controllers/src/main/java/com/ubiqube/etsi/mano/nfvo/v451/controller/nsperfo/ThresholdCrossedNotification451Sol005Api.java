...
@RequestMapping(value = "/sol005/nspm/v2", headers = { "Version=2.12.0" })
@RolesAllowed({ "ROLE_OSSBSS" })
@Validated
public interface ThresholdCrossedNotification451Sol005Api {

	Logger log = LoggerFactory.getLogger(ThresholdCrossedNotification451Sol005Api.class);
