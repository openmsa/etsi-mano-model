...
@RestController
public class VnfSubscriptions451Sol003Controller implements VnfSubscriptions451Sol003Api, SubscriptionLinkable451Nfvo {
	...
	public VnfSubscriptions451Sol003Controller(final VnfSubscriptionSol005FrontController vnfSubscriptionSol03FrontController, final PkgmSubscriptionRequest451Mapping mapper) {
	...
	public String makeSelfLink(final String id) {
		return linkTo(methodOn(VnfSubscriptions451Sol003Api.class).subscriptionsSubscriptionIdGet(id)).withSelfRel().getHref();
	}
