...
@Validated
public interface AlarmSubscriptions451Sol005Api {

	Logger log = LoggerFactory.getLogger(AlarmSubscriptions451Sol005Api.class);
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about an individual subscription has been read successfully. The response body shall contain a representation of the subscription resource. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = FmSubscription.class))),
