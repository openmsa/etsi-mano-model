...
import com.ubiqube.etsi.mano.v451.model.em.vnflcm.VnfIdentifierCreationNotification;
import com.ubiqube.etsi.mano.v451.service.mapping.VnfLvmNotification451Mapping;

import jakarta.validation.Valid;

@RestController
public class VnfIdentifierCreationNotification451Sol005Controller implements VnfIdentifierCreationNotification451Sol005Api {
	private final VnfLcmNotificationFrontController fc;
	private final VnfLvmNotification451Mapping mapper;

	public VnfIdentifierCreationNotification451Sol005Controller(final VnfLcmNotificationFrontController fc, final VnfLvmNotification451Mapping mapper) {
		this.fc = fc;
		this.mapper = mapper;
	}
	...
	public ResponseEntity<Void> creationNotificationPost(@Valid final VnfIdentifierCreationNotification body) {
		...
		return fc.creationNotification(req, "4.5.1");
	}
