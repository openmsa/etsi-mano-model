...
@Validated
public interface VnfLcmOperationOccurrenceNotification451Sol005Api {

	Logger log = LoggerFactory.getLogger(VnfLcmOperationOccurrenceNotification451Sol005Api.class);
