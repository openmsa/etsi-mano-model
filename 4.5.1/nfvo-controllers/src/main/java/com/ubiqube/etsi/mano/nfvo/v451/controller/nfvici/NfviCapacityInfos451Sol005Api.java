...
import com.ubiqube.etsi.mano.nfvo.v451.model.nfvici.NfviCapacityInfo;
...
@Validated
public interface NfviCapacityInfos451Sol005Api {

	Logger log = LoggerFactory.getLogger(NfviCapacityInfos451Sol005Api.class);
	...
	default ResponseEntity<List<NfviCapacityInfo>> nfviCapacityInfosGet(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization,
		...
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			...
			log.warn("ObjectMapper or HttpServletRequest not configured in default NfviCapacityInfosApi interface so no example is generated");
		}
	...
	default ResponseEntity<NfviCapacityInfo> nfviCapacityInfosVimIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of the VIM with associated NFVI capacity information. This identifier can be retrieved from the \"vimId\" attribute in the CapacityShortageNotification. It can also be retrieved from the \"vimId\" attribute in the message content of the response. ", required = true, schema = @Schema()) @PathVariable("vimId") final String vimId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization,
		...
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue(
							"{\n  \"capacityInfoPerZone\" : [ {\n    \"capacityMeasurements\" : [ {\n      \"reservedCapacity\" : { },\n      \"availableCapacity\" : { },\n      \"allocatedCapacity\" : { },\n      \"capacityMeasurementName\" : \"capacityMeasurementName\",\n      \"totalCapacity\" : { },\n      \"resourceType\" : \"VR_COMPUTE\"\n    }, {\n      \"reservedCapacity\" : { },\n      \"availableCapacity\" : { },\n      \"allocatedCapacity\" : { },\n      \"capacityMeasurementName\" : \"capacityMeasurementName\",\n      \"totalCapacity\" : { },\n      \"resourceType\" : \"VR_COMPUTE\"\n    } ]\n  }, {\n    \"capacityMeasurements\" : [ {\n      \"reservedCapacity\" : { },\n      \"availableCapacity\" : { },\n      \"allocatedCapacity\" : { },\n      \"capacityMeasurementName\" : \"capacityMeasurementName\",\n      \"totalCapacity\" : { },\n      \"resourceType\" : \"VR_COMPUTE\"\n    }, {\n      \"reservedCapacity\" : { },\n      \"availableCapacity\" : { },\n      \"allocatedCapacity\" : { },\n      \"capacityMeasurementName\" : \"capacityMeasurementName\",\n      \"totalCapacity\" : { },\n      \"resourceType\" : \"VR_COMPUTE\"\n    } ]\n  } ],\n  \"timeInterval\" : {\n    \"aTime\" : \"2000-01-23T04:56:07.000+00:00\"\n  },\n  \"id\" : \"id\"\n}",
							NfviCapacityInfo.class), HttpStatus.NOT_IMPLEMENTED);
				} catch (final IOException e) {
					log.error("Couldn't serialize response for content type application/json", e);
					return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
				}
