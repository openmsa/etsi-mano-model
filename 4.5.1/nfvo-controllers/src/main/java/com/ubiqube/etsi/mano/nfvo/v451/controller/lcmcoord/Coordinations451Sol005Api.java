...
import com.ubiqube.etsi.mano.nfvo.v451.model.lcmcoord.LcmCoord;
import com.ubiqube.etsi.mano.nfvo.v451.model.lcmcoord.LcmCoordRequest;
...
public interface Coordinations451Sol005Api {
	...
	Logger log = LoggerFactory.getLogger(Coordinations451Sol005Api.class);
	...
	default ResponseEntity<LcmCoord> coordinationsCoordinationIdGet(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.PATH, description = "Identifier of the LCM coordination.  NOTE: This identifier can be retrieved from the resource referenced by the        \"Location\" HTTP header in the response to a POST request to the        \"Coordinations\" resource. ", required = true, schema = @Schema()) @PathVariable("coordinationId") final String coordinationId, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			...
			log.warn("ObjectMapper or HttpServletRequest not configured in default CoordinationsApi interface so no example is generated");
		}
	...
	default ResponseEntity<LcmCoord> coordinationsPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.DEFAULT, description = "Parameters for the coordination action as defined in clause 12.5.2.2.", required = true, schema = @Schema()) @Valid @RequestBody final LcmCoordRequest body, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"http://example.com/aeiou\"\n    }\n  },\n  \"coordinationResult\" : \"CONTINUE\",\n  \"lcmOperationType\" : \"INSTANTIATE\",\n  \"outputParams\" : { },\n  \"coordinationActionName\" : \"coordinationActionName\",\n  \"id\" : \"id\",\n  \"error\" : {\n    \"instance\" : \"instance\",\n    \"detail\" : \"detail\",\n    \"type\" : \"type\",\n    \"title\" : \"title\",\n    \"status\" : 0\n  }\n}", LcmCoord.class), HttpStatus.NOT_IMPLEMENTED);
