 ...
 */
package com.ubiqube.etsi.mano.v451.nfvo.controller.vnfm.vnfind;
...
import com.ubiqube.etsi.mano.v451.service.mapping.PmJobNotification451Mapping;
...
public class VnfIndicatorValueChangeNotification451Sol003Controller implements VnfIndicatorValueChangeNotification451Sol003Api {
	...
	private final PmJobNotification451Mapping mapper;

	public VnfIndicatorValueChangeNotification451Sol003Controller(final VnfIndicatorNotificationFrontController fc, final PmJobNotification451Mapping mapper) {
		this.fc = fc;
		this.mapper = mapper;
	}
