...
import com.ubiqube.etsi.mano.em.v451.model.vnffm.AlarmModifications;
...
@Validated
public interface Alarms451Sol005Api {

	Logger log = LoggerFactory.getLogger(Alarms451Sol005Api.class);
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when the request has been accepted and completed. The response body shall contain attribute modifications for an 'Individual alarm' resource (see clause 8.5.2.8). ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AlarmModifications.class))),
	...
	default ResponseEntity<AlarmModifications> alarmsAlarmIdPatch(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType,
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the alarm. This identifier can be retrieved from the \"id\" attribute of the \"alarm\" attribute in the AlarmNotification or AlarmClearedNotification.  It can also be retrieved from the \"id\" attribute of the applicable array element in the message content of the response to a GET request to the \"Alarms\" resource. ", required = true, schema = @Schema()) @PathVariable("alarmId") final String alarmId, @Parameter(in = ParameterIn.DEFAULT, description = "The parameter for the alarm modification, as defined in clause 8.5.2.8.", required = true, schema = @Schema()) @Valid @RequestBody final AlarmModifications body, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
