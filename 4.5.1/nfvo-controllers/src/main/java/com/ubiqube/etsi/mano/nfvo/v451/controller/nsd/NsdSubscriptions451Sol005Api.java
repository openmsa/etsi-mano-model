...
import com.ubiqube.etsi.mano.nfvo.v451.model.nsd.NsdmSubscription;
import com.ubiqube.etsi.mano.nfvo.v451.model.nsd.NsdmSubscriptionRequest;
...
@RequestMapping(value = "/sol005/nsd/v2", headers = { "Version=2.12.0" })
@RolesAllowed({ "ROLE_OSSBSS" })
@Validated
public interface NsdSubscriptions451Sol005Api {

	Logger log = LoggerFactory.getLogger(NsdSubscriptions451Sol005Api.class);
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "422", description = "422 Unprocessable Content  Shall be returned upon the following error: The content type of the message content is supported and the message content of a request contains syntactically correct data but the data cannot be processed. The general cause for this error and its handling is specified in clause 6.4 of ETSI GS NFV-SOL 013 [16], including rules for the presence of the response body. Specifically in case of this resource, the response code 422 shall also be returned if the NFVO has tested the Notification endpoint as described in clause 5.4.10.3.2 and the test has failed. In this case, the \"detail\" attribute in the \"ProblemDetails\" structure shall convey more information about the error. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProblemDetails.class))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when information about an individual subscription has been read successfully. The response body shall contain a representation of the subscription resource. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NsdmSubscription.class))),
