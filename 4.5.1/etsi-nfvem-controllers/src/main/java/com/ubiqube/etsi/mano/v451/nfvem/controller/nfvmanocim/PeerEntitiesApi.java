...
public interface PeerEntitiesApi {
	...
	Logger log = LoggerFactory.getLogger(PeerEntitiesApi.class);
	...
	default ResponseEntity<List<PeerEntity>> peerEntitiesGet(
		...
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			...
			log.warn("ObjectMapper or HttpServletRequest not configured in default PeerEntitiesApi interface so no example is generated");
		}
		return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
	}

	@Operation(summary = "", description = "This method deletes an individual peer entity resource. By deleting such a resource in the producer NFV-MANO functional entity representing a peer NFV-MANO entity, the configuration and information with regards to such peer entity is deleted. Consequently, the peering relationship between the producer NFV-MANO functional entity and the peer entity is terminated, i.e. the producer NFV-MANO functional entity does not have the necessary information to communicate/interact with the peer entity. See clause 5.5.14.3.5. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "204", description = "204 NO CONTENT Shall be returned when the \"Individual peer entity\" resource  has been deleted successfully. The response body shall be empty. "),

			@ApiResponse(responseCode = "409", description = "409 CONFLICT. Shall be returned upon the following error: The operation cannot be  executed currently, due to a conflict with the state of the  \"Individual peer entity\" resource. Typically, this is due to the fact that another operation is ongoing. The response body shall contain a ProblemDetails structure, in which  the \"detail\" attribute should convey more information about the error. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProblemDetails.class))),
	...
	default ResponseEntity<Void> peerEntitiesPeerEntityIdDelete(
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the peer entity ", required = true, schema = @Schema()) @PathVariable("peerEntityId") final String peerEntityId,
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
	...
	@Operation(summary = "", description = "The GET method retrieves information and configuration hold in the producer NFV-MANO functional entity with regards to a peer entity by reading an individual peer entity resource. See clause 5.5.14.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about an individual peer functional entity has been read successfully. The response body shall contain a resource representation of the peer functional entity, as defined in clause 5.6.2.15. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PeerEntity.class))),
	...
	default ResponseEntity<PeerEntity> peerEntitiesPeerEntityIdGet(
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the peer entity ", required = true, schema = @Schema()) @PathVariable("peerEntityId") final String peerEntityId,
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"vimConnectionInfos\" : [ { }, { } ],\n  \"consumedManoInterfaces\" : { },\n  \"name\" : \"name\",\n  \"vnfmConfiguredVimConnectionInfoIds\" : [ null, null ],\n  \"description\" : \"description\",\n  \"id\" : \"id\",\n  \"type\" : \"NFVO\",\n  \"peerEntityState\" : {\n    \"administrativeState\" : \"LOCKED\",\n    \"operationalState\" : \"STARTED\"\n  }\n}", PeerEntity.class), HttpStatus.NOT_IMPLEMENTED);
				} catch (final IOException e) {
					log.error("Couldn't serialize response for content type application/json", e);
					return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
				}
	...
	@Operation(summary = "", description = "This method modifies configuration and information of the producer NFV-MANO functional entity with regards to a peer functional entity by updating the corresponding \"Individual peer entity\" resource. See clause 5.5.14.3.4. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when the request has been accepted and completed. The response body shall contain a representation of the attribute modifications for the \"Individual peer entity\" resource, as defined in clause 5.6.2.17. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PeerEntityConfigModifications.class))),
	...
	default ResponseEntity<PeerEntityConfigModifications> peerEntitiesPeerEntityIdPatch(
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the peer entity ", required = true, schema = @Schema()) @PathVariable("peerEntityId") final String peerEntityId,
			@Parameter(in = ParameterIn.DEFAULT, description = "Parameters for the modification of configuration parameters of the peer functional entity, as defined in clause 5.6.2.16The Content-Type header shall be set to \"application/merge-patch+json\" according to IETF RFC 7396.", required = true, schema = @Schema()) @Valid @RequestBody final PeerEntityConfigModificationRequest body,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"vimConnectionInfos\" : [ { }, { } ],\n  \"consumedManoInterfaces\" : { },\n  \"administrativeState\" : \"LOCKED\",\n  \"name\" : \"name\",\n  \"description\" : \"description\",\n  \"operationalState\" : \"STARTED\"\n}", PeerEntityConfigModifications.class), HttpStatus.NOT_IMPLEMENTED);
				} catch (final IOException e) {
					log.error("Couldn't serialize response for content type application/json", e);
					return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
				}
	...
	@Operation(summary = "", description = "The POST method creates in the producer NFV-MANO functional entity a new peer entity resource which contains configuration and information with regards to the peer functional entity. See clause 5.5.13.3.1 ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED Shall be returned when a new \"Individual peer entity\" resource has been created successfully. The response body shall contain a representation of the created resource with regards to a peer entity, as defined in clause 5.6.2.15. The HTTP response shall include a “Location” HTTP header that points to the created \"Individual peer entity\" resource. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PeerEntity.class))),
	...
	default ResponseEntity<PeerEntity> peerEntitiesPost(
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.DEFAULT, description = "The peer entity creation parameters, as defined in clause 5.6.2.14.", required = true, schema = @Schema()) @Valid @RequestBody final CreatePeerEntityRequest body,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
