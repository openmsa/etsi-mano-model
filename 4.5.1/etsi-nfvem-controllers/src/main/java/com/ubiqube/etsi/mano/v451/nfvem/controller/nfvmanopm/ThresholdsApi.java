...
public interface ThresholdsApi {
	...
	@Operation(summary = "", description = "The client can use this method to query information about thresholds. See clause 6.5.6.3.2. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "", description = "The POST method can be used by the client to create a threshold. See clause 6.5.6.3.1. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED Shall be returned when a threshold has been created successfully.  The response body shall contain a representation of the created  \"Individual threshold\" resource, as defined in clause 6.6.2.9. The HTTP response shall include a \"Location\" HTTP header that  contains the resource URI of the created \"Individual threshold\"  resource. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Threshold.class))),
	...
	default ResponseEntity<Threshold> thresholdsPost(
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.DEFAULT, description = "Request parameters to create a threshold. ", required = true, schema = @Schema()) @Valid @RequestBody final CreateThresholdRequest body,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
	...
	@Operation(summary = "", description = "This method allows to delete a threshold. See clause 6.5.7.3.5. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<Void> thresholdsThresholdIdDelete(
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM threshold", required = true, schema = @Schema()) @PathVariable("thresholdId") final String thresholdId,
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
	...
	@Operation(summary = "", description = "The client can use this method for reading an individual threshold. See clause 6.5.7.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about an individual threshold  has been read successfully. The response body shall contain a representation of the threshold,  as defined in clause 6.6.2.9. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Threshold.class))),
	...
	@Operation(summary = "", description = "This method allows to modify an \"Individual threshold\" resource. See clause 6.5.7.3.4. ", tags = {})
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "504", description = "504 GATEWAY TIMEOUT If the API producer encounters a timeout while waiting for a response from an upstream server (i.e. a server that the API producer communicates with when fulfilling a request), it should respond with this response code. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProblemDetails.class))) })
	@RequestMapping(value = "/thresholds/{thresholdId}", produces = { "application/json" }, consumes = { "application/merge-patch+json" }, method = RequestMethod.PATCH)
	default ResponseEntity<ThresholdModifications> thresholdsThresholdIdPatch(
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM threshold", required = true, schema = @Schema()) @PathVariable("thresholdId") final String thresholdId,
			@Parameter(in = ParameterIn.DEFAULT, description = "Parameters for the threshold modification. The Content-Type header shall be set to \"application/merge-patch+json\" according to IETF RFC 7396.", required = true, schema = @Schema()) @Valid @RequestBody final ThresholdModifications body,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
