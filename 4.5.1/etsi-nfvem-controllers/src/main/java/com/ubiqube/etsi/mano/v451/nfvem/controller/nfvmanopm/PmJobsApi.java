...
public interface PmJobsApi {
	...
	@Operation(summary = "", description = "This method terminates an individual PM job. See clause 6.5.4.3.5. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<Void> pmJobsPmJobIdDelete(
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM Job", required = true, schema = @Schema()) @PathVariable("pmJobId") final String pmJobId,
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
	...
	@Operation(summary = "", description = "The client can use this method for reading an individual PM job. See clause 6.5.4.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about an individual PM job  has been read successfully. The response body shall contain a representation of the \"Individual PM job\" resource, as defined in clause 6.6.2.7. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PmJob.class))),
	...
	@Operation(summary = "", description = "This method allows to modify an \"individual PM job\" resource. See clause 6.5.4.3.4. ", tags = {})
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "504", description = "504 GATEWAY TIMEOUT If the API producer encounters a timeout while waiting for a response from an upstream server (i.e. a server that the API producer communicates with when fulfilling a request), it should respond with this response code. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProblemDetails.class))) })
	@RequestMapping(value = "/pm_jobs/{pmJobId}", produces = { "application/json" }, consumes = { "application/merge-patch+json" }, method = RequestMethod.PATCH)
	default ResponseEntity<PmJobModifications> pmJobsPmJobIdPatch(
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM Job", required = true, schema = @Schema()) @PathVariable("pmJobId") final String pmJobId,
			@Parameter(in = ParameterIn.DEFAULT, description = "Parameters for the PM job modification. The Content-Type header shall be set to \"application/merge-patch+json\" according to IETF RFC 7396.", required = true, schema = @Schema()) @Valid @RequestBody final PmJobModifications body,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
	...
	@Operation(summary = "", description = "The client can use this method for reading an individual performance report. See clause 6.5.5.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information of an individual performance  report has been read successfully. The response body shall contain a representation of the  \"Individual performance report\" resource, as defined  in clause 6.6.2.10. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PerformanceReport.class))),
	...
	default ResponseEntity<PerformanceReport> pmJobsPmJobIdReportsReportIdGet(
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM Job", required = true, schema = @Schema()) @PathVariable("pmJobId") final String pmJobId,
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM report", required = true, schema = @Schema()) @PathVariable("reportId") final String reportId,
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
	...
	@Operation(summary = "", description = "The POST method creates a PM job. See clause 6.5.3.3.1. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<PmJob> pmJobsPost(
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.DEFAULT, description = "PM job creation request.", required = true, schema = @Schema()) @Valid @RequestBody final CreatePmJobRequest body,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
