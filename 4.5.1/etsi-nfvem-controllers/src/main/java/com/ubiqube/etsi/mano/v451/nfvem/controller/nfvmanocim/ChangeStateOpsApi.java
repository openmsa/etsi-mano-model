...
public interface ChangeStateOpsApi {
	...
	Logger log = LoggerFactory.getLogger(ChangeStateOpsApi.class);
	...
	default ResponseEntity<ChangeStateOpOcc> changeStateOpsChangeStateOpOccIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of the change state operation occurrence ", required = true, schema = @Schema()) @PathVariable("changeStateOpOccId") final String changeStateOpOccId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			...
			log.warn("ObjectMapper or HttpServletRequest not configured in default ChangeStateOpsApi interface so no example is generated");
		}
