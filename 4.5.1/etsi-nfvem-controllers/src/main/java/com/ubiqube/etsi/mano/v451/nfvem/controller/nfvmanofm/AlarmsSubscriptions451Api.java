...
@Validated
public interface AlarmsSubscriptions451Api {

	Logger log = LoggerFactory.getLogger(AlarmsSubscriptions451Api.class);
	...
	@Operation(summary = "", description = "The POST method creates a new subscription. See clause 7.5.5.3.1. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<FmSubscription> subscriptionsPost(
			...
			@Parameter(in = ParameterIn.DEFAULT, description = "Details of the subscription to be created, as defined in clause 7.6.2.2.", required = true, schema = @Schema()) @Valid @RequestBody final FmSubscriptionRequest body,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
	...
	@Operation(summary = "", description = "This method terminates an individual subscription. See clause 7.5.6.3.5. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "", description = "The client can use this method for reading an individual subscription for NFV-MANO functional entity alarms subscribed by the client. See clause 7.5.6.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK The operation has completed successfully. The response body shall contain a representation of the subscription resource. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = FmSubscription.class))),
