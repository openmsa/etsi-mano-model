...
import com.ubiqube.etsi.mano.em.v451.model.vnflcm.ResourceHandle;
...
/**
 * This type provides information of an existing or proposed resource or PaaS
 * Service used by the VNF. NOTE 1: The use cases UC#4 and UC#5 in Annex A.4 of
 * ETSI GS NFV-IFA 007 provide examples for such a configuration. NOTE 2: In the
 * context of an operation that changes the current VNF package, the following
 * applies: If this ResourceDefinition is related to a resource to be created or
 * modified, the \&quot;vnfdId\&quot; attribute shall contain the identifier of
 * the destination VNFD. If this ResourceDefinition is related to a resource to
 * be deleted, the \&quot;vnfdId\&quot; attribute shall contain the identifier
 * of the source VNFD. If this ResourceDefinition is related to a temporary
 * resource, the \&quot;vnfdId\&quot; attribute shall contain the identifier of
 * either the source VNFD or the destination VNFD.
 */
@Schema(description = "This type provides information of an existing or proposed resource or PaaS Service used by the VNF. NOTE 1: The use cases UC#4 and UC#5 in Annex A.4 of ETSI GS NFV-IFA 007 provide examples           for such a configuration. NOTE 2: In the context of an operation that changes the current VNF package, the following applies: If this           ResourceDefinition is related to a resource to be created or modified, the \"vnfdId\" attribute shall           contain the identifier of the destination VNFD. If this ResourceDefinition is related to a resource           to be deleted, the \"vnfdId\" attribute shall contain the identifier of the source VNFD. If this           ResourceDefinition is related to a temporary resource, the \"vnfdId\" attribute shall contain the           identifier of either the source VNFD or the destination VNFD. ")
@Validated
...
public class ResourceDefinition {
	 ...
	 * * STORAGE * LINKPORT * OSCONTAINER * VIRTUALCP * PAASSERVICE
	 */
	...
	@Valid
	private List<String> resourceTemplateId = new ArrayList<>();
	...
	public ResourceDefinition resourceTemplateId(final List<String> resourceTemplateId) {
		this.resourceTemplateId = resourceTemplateId;
		return this;
	}

	public ResourceDefinition addResourceTemplateIdItem(final String resourceTemplateIdItem) {
		this.resourceTemplateId.add(resourceTemplateIdItem);
		return this;
	}
	 ...
	 * If type=\"OSCONTAINER\": OsContainerDesc - If type=\"VIRTUALCP\": VirtualCpd
	 * - If type=\"PAASSERVICE\": PaasServiceRequest - Cardinality may be greater
	 * than \"1\" when type=\"OSCONTAINER\" and multiple references to
	 * OsContainerDesc are present in the VDU indicated by the \"vduId\".
	 * Cardinality shall be \"1\" otherwise.
	 *
	...
	@Size(min = 1)
	public List<String> getResourceTemplateId() {
		return resourceTemplateId;
	}

	public void setResourceTemplateId(final List<String> resourceTemplateId) {
		this.resourceTemplateId = resourceTemplateId;
	}
