...
public class ChangeVnfPackageData {
	...
	public ChangeVnfPackageData selectedDeployableModule(final List<String> selectedDeployableModule) {
		this.selectedDeployableModule = selectedDeployableModule;
		return this;
	}

	public ChangeVnfPackageData addSelectedDeployableModuleItem(final String selectedDeployableModuleItem) {
	...
	/**
	 * References a selected deployable module, as defined in the VNFD. If this
	 * attribute is present only VNFCs based on VDUs that belong to deployable
	 * modules listed in this attribute are requested to be instantiated or
	 * preserved if they were already instantiated. If this attribute is not present
	 * the deployable modules that were selected before the operation, and that
	 * still are defined in the VNFD in the destination package, or the
	 * corresponding ones according to the component mappings, remain valid. See
	 * note 2.
	 *
	 * @return selectedDeployableModule
	 **/
	@Schema(description = "References a selected deployable module, as defined in the VNFD. If this attribute is present only VNFCs based on VDUs that belong to deployable  modules listed in this attribute are requested to be instantiated or preserved  if they were already instantiated. If this attribute is not present the deployable modules that were selected before the operation, and that still are defined in the VNFD in the destination package, or the corresponding ones according to the component mappings, remain valid. See note 2. ")
	...
	public ChangeVnfPackageData certificateConfigurationData(final CertificateConfigurationData certificateConfigurationData) {
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.vnfInstanceId, changeVnfPackageData.vnfInstanceId) &&
				...
				Objects.equals(this.selectedDeployableModule, changeVnfPackageData.selectedDeployableModule) &&
				Objects.equals(this.certificateConfigurationData, changeVnfPackageData.certificateConfigurationData);
	}

	@Override
	public int hashCode() {
		return Objects.hash(vnfInstanceId, vnfdId, extVirtualLinks, extManagedVirtualLinks, additionalParams, extensions, vnfConfigurableProperties, overridingVersionDependency, selectedDeployableModule, certificateConfigurationData);
	}
