 ...
 * any other case. * NOTE 8: It shall be present when \&quot;type\&quot;
 * attribute is \&quot;CIR\&quot;, and it shall be absent in any other case. *
 * NOTE 9: It shall be present when \&quot;type\&quot; attribute is
 * \&quot;CCM\&quot;, and it shall be absent in any other case. * NOTE 10: It
 * shall be present when \&quot;type\&quot; attribute is \&quot;MDAF\&quot;, and
 * it shall be absent in any other case. * NOTE 11: It shall be present when
 * \&quot;type\&quot; attribute is \&quot;CMF\&quot;, and it shall be absent in
 * any other case.
 */
...
public class ManoEntity {
	...
	@JsonProperty("cirSpecificInfo")
	private CirSpecificInfo cirSpecificInfo = null;

	@JsonProperty("ccmSpecificInfo")
	private CcmSpecificInfo ccmSpecificInfo = null;

	@JsonProperty("mdafSpecificInfo")
	private MdafSpecificInfo mdafSpecificInfo = null;
	...
	public ManoEntity cirSpecificInfo(final CirSpecificInfo cirSpecificInfo) {
		this.cirSpecificInfo = cirSpecificInfo;
		return this;
	}
	 ...
	 * Get cirSpecificInfo
	 *
	 * @return cirSpecificInfo
	 **/
	@Schema(description = "")

	@Valid
	public CirSpecificInfo getCirSpecificInfo() {
		return cirSpecificInfo;
	}

	public void setCirSpecificInfo(final CirSpecificInfo cirSpecificInfo) {
		this.cirSpecificInfo = cirSpecificInfo;
	}

	public ManoEntity ccmSpecificInfo(final CcmSpecificInfo ccmSpecificInfo) {
		this.ccmSpecificInfo = ccmSpecificInfo;
		return this;
	}
	 ...
	 * Get ccmSpecificInfo
	 *
	 * @return ccmSpecificInfo
	 **/
	@Schema(description = "")

	@Valid
	public CcmSpecificInfo getCcmSpecificInfo() {
		return ccmSpecificInfo;
	}

	public void setCcmSpecificInfo(final CcmSpecificInfo ccmSpecificInfo) {
		this.ccmSpecificInfo = ccmSpecificInfo;
	}

	public ManoEntity mdafSpecificInfo(final MdafSpecificInfo mdafSpecificInfo) {
		this.mdafSpecificInfo = mdafSpecificInfo;
		return this;
	}

	/**
	 * Get mdafSpecificInfo
	 *
	 * @return mdafSpecificInfo
	 **/
	@Schema(description = "")

	@Valid
	public MdafSpecificInfo getMdafSpecificInfo() {
		return mdafSpecificInfo;
	}

	public void setMdafSpecificInfo(final MdafSpecificInfo mdafSpecificInfo) {
		this.mdafSpecificInfo = mdafSpecificInfo;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.id, manoEntity.id) &&
				...
				Objects.equals(this.cirSpecificInfo, manoEntity.cirSpecificInfo) &&
				Objects.equals(this.ccmSpecificInfo, manoEntity.ccmSpecificInfo) &&
				Objects.equals(this.mdafSpecificInfo, manoEntity.mdafSpecificInfo) &&
				Objects.equals(this._links, manoEntity._links);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, type, name, description, provider, softwareVersion, softwareInfo, manoEntityComponents, manoServices, manoConfigurableParams, manoApplicationState, nfvoSpecificInfo, vnfmSpecificInfo, vimSpecificInfo, wimSpecificInfo, cismSpecificInfo, cirSpecificInfo, ccmSpecificInfo, mdafSpecificInfo, _links);
	}
	...
	public String toString() {
		...
		sb.append("    cirSpecificInfo: ").append(toIndentedString(cirSpecificInfo)).append("\n");
		sb.append("    ccmSpecificInfo: ").append(toIndentedString(ccmSpecificInfo)).append("\n");
		sb.append("    mdafSpecificInfo: ").append(toIndentedString(mdafSpecificInfo)).append("\n");
