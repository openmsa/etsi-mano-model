...
import com.ubiqube.etsi.mano.v451.model.nfvo.nfvici.NfviCapacityResourceTypeEnumeration;
...
public class NfviCapacityMeasurement   {
   ...
   **/
  @Schema(requiredMode = RequiredMode.REQUIRED, description = "Name of the capacity measurement. Different resource types can have different associated capacity measurements, typically associated to different sub-types of the resource type. See note. ")
      @NotNull
