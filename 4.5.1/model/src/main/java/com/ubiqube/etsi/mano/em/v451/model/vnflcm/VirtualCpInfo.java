 ...
 * NOTE 1: A consumer of the VNF LCM interface can learn the actual VNFC
 ...
 * \&quot;vduIds\&quot; values. * NOTE 2: The information can be omitted because
 * it is already available as part of the external CP information in the
 * VnfExtCpInfo structure.
 */
@Schema(description = "This type provides information related to a virtual CP instance of a VNF. * NOTE 1: A consumer of the VNF LCM interface can learn the actual VNFC instances implementing the service            accessible via the virtual CP instance by querying the \"vnfcResourceInfo\" from the \"InstantiatedVnfInfo\"        and filtering by corresponding \"vduIds\" values. * NOTE 2: The information can be omitted because it is already available as part of the external CP information in the           VnfExtCpInfo structure. ")
@Validated
...
public class VirtualCpInfo {
	 ...
	 * layer protocol supported. This attribute may be omitted if the virtual CP is
	 * exposed as an external CP. See note 2.
	 *
	 * @return cpProtocolInfo
	 **/
	@Schema(description = "Protocol information for this CP. There shall be one cpProtocolInfo for each layer protocol supported. This attribute may be omitted if the virtual CP is exposed as an external CP. See note 2. ")
	@Valid
