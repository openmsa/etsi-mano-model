...
import com.ubiqube.etsi.mano.em.v451.model.vnflcm.PaasServiceInfo;
...
public class NsInstance {
	...
	@JsonProperty("dataFlowMirroringInfo")
	@Valid
	private List<MirroringInfo> dataFlowMirroringInfo = null;

	@JsonProperty("nsPaasServiceInfo")
	@Valid
	 ...
	 * referenced in this NsInstance with nsdId and for NSDs with the same
	 * \"nsdExtInvariantId\". There shall not be more than one versionDependency
	 * present with the same dependentConstituentId. It may be present for the
	 * NsInstance of a nested NS. It shall not be present otherwise.
	 *
	...
	public NsInstance dataFlowMirroringInfo(final List<MirroringInfo> dataFlowMirroringInfo) {
		this.dataFlowMirroringInfo = dataFlowMirroringInfo;
		return this;
	}

	public NsInstance addDataFlowMirroringInfoItem(final MirroringInfo dataFlowMirroringInfoItem) {
		if (this.dataFlowMirroringInfo == null) {
			this.dataFlowMirroringInfo = new ArrayList<>();
		}
		this.dataFlowMirroringInfo.add(dataFlowMirroringInfoItem);
		return this;
	}
	 ...
	 *
	 * @return dataFlowMirroringInfo
	 **/
	@Schema(description = "Information related to Data Flow Mirroring associated to this NS instance ")
	@Valid
	public List<MirroringInfo> getDataFlowMirroringInfo() {
		return dataFlowMirroringInfo;
	}

	public void setDataFlowMirroringInfo(final List<MirroringInfo> dataFlowMirroringInfo) {
		this.dataFlowMirroringInfo = dataFlowMirroringInfo;
	}

	public NsInstance nsPaasServiceInfo(final List<PaasServiceInfo> nsPaasServiceInfo) {
		this.nsPaasServiceInfo = nsPaasServiceInfo;
		return this;
	}

	public NsInstance addNsPaasServiceInfoItem(final PaasServiceInfo nsPaasServiceInfoItem) {
		if (this.nsPaasServiceInfo == null) {
			this.nsPaasServiceInfo = new ArrayList<>();
		}
		this.nsPaasServiceInfo.add(nsPaasServiceInfoItem);
		return this;
	}

	/**
	 * Information on the PaaS Services assigned and used by an NS constituent other
	 * than VNF instances. See note 4.
	 *
	 * @return nsPaasServiceInfo
	 **/
	@Schema(description = "Information on the PaaS Services assigned and used by an NS constituent  other than VNF instances. See note 4.  ")
	@Valid
	public List<PaasServiceInfo> getNsPaasServiceInfo() {
		return nsPaasServiceInfo;
	}

	public void setNsPaasServiceInfo(final List<PaasServiceInfo> nsPaasServiceInfo) {
		this.nsPaasServiceInfo = nsPaasServiceInfo;
	}
