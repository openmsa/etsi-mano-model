...
public class OperateVnfData {
	...
	public OperateVnfData additionalParams(final Map<String, String> additionalParams) {
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.vnfInstanceId, operateVnfData.vnfInstanceId) &&
				...
				Objects.equals(this.additionalParams, operateVnfData.additionalParams);
	}

	@Override
	public int hashCode() {
		return Objects.hash(vnfInstanceId, changeStateTo, stopType, gracefulStopTimeout, additionalParams);
	}
