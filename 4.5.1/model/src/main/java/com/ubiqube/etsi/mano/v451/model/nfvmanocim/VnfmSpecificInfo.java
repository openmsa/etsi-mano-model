...
/**
 * This type represents information attributes specific to a VNFM entity, and that can be relevant to more than one NFV-MANO service offered by a VNFM entity. * NOTE: The information to be provided in this attribute shall relate to the specification and version         of the specification. For instance, \&quot;ETSI GS NFV-SOL 001 (V2.5.1)\&quot;. 
 */
...
public class VnfmSpecificInfo   {
  ...
  public VnfmSpecificInfo certificateManagementMode(List<CertificateManagementModeEnum> certificateManagementMode) {
    this.certificateManagementMode = certificateManagementMode;
    return this;
  }

  public VnfmSpecificInfo addCertificateManagementModeItem(CertificateManagementModeEnum certificateManagementModeItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.resoruceMgmtModeSupport, vnfmSpecificInfo.resoruceMgmtModeSupport) &&
        ...
        Objects.equals(this.certificateManagementMode, vnfmSpecificInfo.certificateManagementMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resoruceMgmtModeSupport, managedVnfInstanceInfos, supportedVnfdFormats, certificateManagementMode);
  }
