...
public class ClientInterfaceSecurityInfoOauthServerInfoDynamicDiscovery   {
   ...
   **/
  @Schema(requiredMode = RequiredMode.REQUIRED, description = "Server where the WebFinger service is hosted. When used, the request to the WebFinger resource shall conform as specified in clause 5.1.3 of ETSI GS NFV-SEC 022. ")
      @NotNull
