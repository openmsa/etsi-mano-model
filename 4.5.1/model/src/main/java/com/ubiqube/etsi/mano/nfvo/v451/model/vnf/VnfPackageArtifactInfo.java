 ...
 * defined in Table 9.5.3.3-1. NOTE: The attribute name
 * \&quot;artifactURI\&quot; does not comply with the naming convention defined
 * in clause 4.3 of ETSI GS NFV-SOL 015. This is to maintain the backward
 * compatibility.
 */
@Schema(description = "This type represents an artifact other than a software image which is contained  in or external to a VNF package. It shall comply with provisions defined in  Table 9.5.3.3-1. NOTE: The attribute name \"artifactURI\" does not comply with the naming convention  defined in clause 4.3 of ETSI GS NFV-SOL 015. This is to maintain the backward  compatibility. ")
@Validated
