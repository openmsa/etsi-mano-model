...
import com.ubiqube.etsi.mano.nfvo.v451.model.nslcm.VersionDependency;
...
/**
 * This type represents the information to override or add a version dependency in the runtime information that the NFVO keeps about a profile of a NSD constituent. It shall comply with the provisions defined in table 6.5.3.111-1. NOTE: If the referenced profile contains a \&quot;versionDependency\&quot; with       a dependentConstituent equal to the one indicated in the        \&quot;versionDependency\&quot; attribute of this data type, the        \&quot;versionDependency\&quot; in this data type overrides the one        in the profile, otherwise it is added to the version        dependencies in the profile. 
 */
@Schema(description = "This type represents the information to override or add a version dependency in the runtime information that the NFVO keeps about a profile of a NSD constituent. It shall comply with the provisions defined in table 6.5.3.111-1. NOTE: If the referenced profile contains a \"versionDependency\" with       a dependentConstituent equal to the one indicated in the        \"versionDependency\" attribute of this data type, the        \"versionDependency\" in this data type overrides the one        in the profile, otherwise it is added to the version        dependencies in the profile. ")
@Validated
