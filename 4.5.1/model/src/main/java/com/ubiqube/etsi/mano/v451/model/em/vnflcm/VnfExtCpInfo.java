...
public class VnfExtCpInfo implements OneOfVnfExtCpInfo {
	...
	public VnfExtCpInfo certificateContentId(final String certificateContentId) {
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.id, vnfExtCpInfo.id) &&
				...
				Objects.equals(this.certificateContentId, vnfExtCpInfo.certificateContentId);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, cpdId, cpConfigId, vnfdId, cpProtocolInfo, extLinkPortId, metadata, associatedVnfcCpId, associatedVipCpId, associatedVirtualCpId, associatedVnfVirtualLinkId, netAttDefResourceId, certificateContentId);
	}
