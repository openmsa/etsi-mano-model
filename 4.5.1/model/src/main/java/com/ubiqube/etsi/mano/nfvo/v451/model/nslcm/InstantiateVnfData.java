...
import com.ubiqube.etsi.mano.em.v451.model.vnflcm.ExtVirtualLinkData;

import io.swagger.v3.oas.annotations.media.Schema;
import jakarta.validation.Valid;

/**
 * The InstantiateVnfData data type specifies the parameters that are needed for
 * VNF instantiation. This information element is used for the bottom-up NS
 * creation when the OSS/BSS explicitly requests VNF instantiation for a given
 * NS. When the NFVO invokes the Instantiate VNF update operation, a set of
 * these parameters are then passed by the NFVO to the VNFM. NOTE 1: It is
 * possible to have several ExtManagedVirtualLinkData for the same VNF internal
 * VL in case of a multi-site VNF spanning several VIMs. The set of
...
public class InstantiateVnfData implements OneOfInstantiateVnfData {
	 ...
	 * as in the \"overridingVersionDependency\" is replaced. See note 8. If no
	 ...
	 * PnfProfile, the new version Dependency is added to the runtime information
	 * that the NFVO keeps about the profile. See note 9.
	 *
	...
	public InstantiateVnfData selectedDeployableModule(final List<String> selectedDeployableModule) {
		this.selectedDeployableModule = selectedDeployableModule;
		return this;
	}

	public InstantiateVnfData addSelectedDeployableModuleItem(final String selectedDeployableModuleItem) {
	 ...
	 **/
	@Schema(description = "References a selected deployable module, as defined in the VNFD. Only VNFCs based on VDUs that belong to deployable modules listed in this attribute are requested to be instantiated. ")
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.defaultInstantiationLevel, instantiateVnfData.defaultInstantiationLevel) &&
				...
				Objects.equals(this.selectedDeployableModule, instantiateVnfData.selectedDeployableModule);
	}
