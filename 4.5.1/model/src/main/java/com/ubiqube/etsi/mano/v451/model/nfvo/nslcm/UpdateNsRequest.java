...
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.AddNsVirtualLinkData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.AddPnfData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.AddVnffgData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.AssocNewNsdVersionData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.ChangeExtVnfConnectivityData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.ChangeNsFlavourData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.ChangeVnfFlavourData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.ChangeVnfPackageData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.CreateDataFlowMirroring;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.CreateVnfSnapshotData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.DeleteVnfSnapshotData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.FeasibilityCheckReserveType;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.InstantiateVnfData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.ModifyPnfData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.ModifyVnfInfoData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.ModifyWanConnectionInfoData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.MoveVnfInstanceData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.NestedNsInstanceData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.OperateVnfData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.RevertVnfToSnapshotData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.SapData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.SelectVnfDeployableModuleData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.TerminateVnfData;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.UpdateDataFlowMirroring;
import com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.UpdateVnffgData;
...
public class UpdateNsRequest   {
  ...
  public enum UpdateTypeEnum {
    ...
    CREATE_DATA_FLOW_MIRRORING("CREATE_DATA_FLOW_MIRRORING"),
    
    DELETE_DATA_FLOW_MIRRORING("DELETE_DATA_FLOW_MIRRORING"),
    
    UPDATE_DATA_FLOW_MIRRORING("UPDATE_DATA_FLOW_MIRRORING"),
    
    SELECT_VNF_DEPL_MODULES("SELECT_VNF_DEPL_MODULES");
  ...
  @JsonProperty("createDataFlowMirroring")
  @Valid
  private List<CreateDataFlowMirroring> createDataFlowMirroring = null;

  @JsonProperty("deleteDataFlowMirroringId")
  @Valid
  private List<String> deleteDataFlowMirroringId = null;

  @JsonProperty("updateDataFlowMirroring")
  @Valid
  private List<UpdateDataFlowMirroring> updateDataFlowMirroring = null;

  @JsonProperty("selectVnfDeployableModuleData")
  @Valid
  private List<SelectVnfDeployableModuleData> selectVnfDeployableModuleData = null;
   ...
   * @return updateType
   **/
  @Schema(requiredMode = RequiredMode.REQUIRED, description = "The type of update. It determines also which one of the following parameters is present in the operation. Possible values include: * ADD_VNF: Adding existing VNF instance(s) * REMOVE_VNF: Removing VNF instance(s) * INSTANTIATE_VNF: Instantiating new VNF(s) * CHANGE_VNF_DF: Changing VNF DF * OPERATE_VNF: Changing VNF state, * MODIFY_VNF_INFORMATION: Modifying VNF information and/or the configurable properties of VNF instance(s) * CHANGE_EXTERNAL_VNF_CONNECTIVITY: Changing the external connectivity of VNF instance(s) * CHANGE_VNFPKG: Changing the VNF package(s) on which (a) VNF instance(s) is/are based (see note 5) * ADD_SAP: Adding SAP(s) * REMOVE_SAP: Removing SAP(s) * ADD_NESTED_NS: Adding existing NS instance(s) as nested NS(s) * REMOVE_NESTED_NS: Removing existing nested NS instance(s) * ASSOC_NEW_NSD_VERSION: Associating a new NSD version to the NS instance * MOVE_VNF: Moving VNF instance(s) from one origin NS instance to another target NS instance * ADD_VNFFG: Adding VNFFG(s) * REMOVE_VNFFG: Removing VNFFG(s) * UPDATE_VNFFG: Updating VNFFG(s) * CHANGE_NS_DF: Changing NS DF * ADD_PNF: Adding PNF * MODIFY_PNF: Modifying PNF * REMOVE_PNF: Removing PNF * CREATE_VNF_SNAPSHOT: Creating VNF Snapshots of VNF instances belonging to the NS instance. See note 2 * REVERT_VNF_TO_SNAPSHOT: Reverting a VNF instance belonging to the NS instance to a VNF Snapshot. See note 2 and note 3 * DELETE_VNF_SNAPSHOT_INFO: Deleting available VNF Snapshot information for a VNF instance belonging to the NS instance. See note 2 * MODIFY_WAN_CONNECTION_INFO: Modify WAN related connectivity information. * CREATE_NS_VIRTUAL_LINK: Create an NsVirtualLink instance. * DELETE_NS_VIRTUAL_LINK: Delete an NsVirtualLink instance. * CREATE_DATA_FLOW_MIRRORING: Create a new data flow mirroring * DELETE_DATA_FLOW_MIRRORING: Delete an existing data flow mirroring * UPDATE_DATA_FLOW_MIRRORING: Update an existing data flow mirroring * SELECT_VNF_DEPL_MODULES: Select deployable modules of a VNF instance ")
      @NotNull
  ...
  public UpdateNsRequest createDataFlowMirroring(List<CreateDataFlowMirroring> createDataFlowMirroring) {
    this.createDataFlowMirroring = createDataFlowMirroring;
    return this;
  }

  public UpdateNsRequest addCreateDataFlowMirroringItem(CreateDataFlowMirroring createDataFlowMirroringItem) {
    if (this.createDataFlowMirroring == null) {
      this.createDataFlowMirroring = new ArrayList<>();
    }
    this.createDataFlowMirroring.add(createDataFlowMirroringItem);
    return this;
  }

  /**
   * Information of the Data Flow Mirroring that are associated with the NS instance.  This parameter  shall be present only if updateType = CREATE_DATA_FLOW_MIRRORING 
   * @return createDataFlowMirroring
   **/
  @Schema(description = "Information of the Data Flow Mirroring that are associated with the NS instance.  This parameter  shall be present only if updateType = CREATE_DATA_FLOW_MIRRORING ")
      @Valid
    public List<CreateDataFlowMirroring> getCreateDataFlowMirroring() {
    return createDataFlowMirroring;
  }

  public void setCreateDataFlowMirroring(List<CreateDataFlowMirroring> createDataFlowMirroring) {
    this.createDataFlowMirroring = createDataFlowMirroring;
  }

  public UpdateNsRequest deleteDataFlowMirroringId(List<String> deleteDataFlowMirroringId) {
    this.deleteDataFlowMirroringId = deleteDataFlowMirroringId;
    return this;
  }

  public UpdateNsRequest addDeleteDataFlowMirroringIdItem(String deleteDataFlowMirroringIdItem) {
    if (this.deleteDataFlowMirroringId == null) {
      this.deleteDataFlowMirroringId = new ArrayList<>();
    }
    this.deleteDataFlowMirroringId.add(deleteDataFlowMirroringIdItem);
    return this;
  }

  /**
   * Identifier of the \"DataFlowMirroringData\" structure that are associated with the NS instance to be deleted. This parameter shall be present only if updateType = DELETE_DATA_FLOW_MIRRORING 
   * @return deleteDataFlowMirroringId
   **/
  @Schema(description = "Identifier of the \"DataFlowMirroringData\" structure that are associated with the NS instance to be deleted. This parameter shall be present only if updateType = DELETE_DATA_FLOW_MIRRORING ")
  
    public List<String> getDeleteDataFlowMirroringId() {
    return deleteDataFlowMirroringId;
  }

  public void setDeleteDataFlowMirroringId(List<String> deleteDataFlowMirroringId) {
    this.deleteDataFlowMirroringId = deleteDataFlowMirroringId;
  }

  public UpdateNsRequest updateDataFlowMirroring(List<UpdateDataFlowMirroring> updateDataFlowMirroring) {
    this.updateDataFlowMirroring = updateDataFlowMirroring;
    return this;
  }

  public UpdateNsRequest addUpdateDataFlowMirroringItem(UpdateDataFlowMirroring updateDataFlowMirroringItem) {
    if (this.updateDataFlowMirroring == null) {
      this.updateDataFlowMirroring = new ArrayList<>();
    }
    this.updateDataFlowMirroring.add(updateDataFlowMirroringItem);
    return this;
  }

  /**
   * Information on the Data Flow Mirroring associated to the NS instance to be updated. This parameter shall be present only if updateType = UPDATE_DATA_FLOW_MIRRORING 
   * @return updateDataFlowMirroring
   **/
  @Schema(description = "Information on the Data Flow Mirroring associated to the NS instance to be updated. This parameter shall be present only if updateType = UPDATE_DATA_FLOW_MIRRORING ")
      @Valid
    public List<UpdateDataFlowMirroring> getUpdateDataFlowMirroring() {
    return updateDataFlowMirroring;
  }

  public void setUpdateDataFlowMirroring(List<UpdateDataFlowMirroring> updateDataFlowMirroring) {
    this.updateDataFlowMirroring = updateDataFlowMirroring;
  }

  public UpdateNsRequest selectVnfDeployableModuleData(List<SelectVnfDeployableModuleData> selectVnfDeployableModuleData) {
    this.selectVnfDeployableModuleData = selectVnfDeployableModuleData;
    return this;
  }

  public UpdateNsRequest addSelectVnfDeployableModuleDataItem(SelectVnfDeployableModuleData selectVnfDeployableModuleDataItem) {
    if (this.selectVnfDeployableModuleData == null) {
      this.selectVnfDeployableModuleData = new ArrayList<>();
    }
    this.selectVnfDeployableModuleData.add(selectVnfDeployableModuleDataItem);
    return this;
  }

  /**
   * Specify the data needed for selecting deployable modules of a VNF instance. This parameter shall be present only if updateType= SELECT_VNF_DEPL_MODULES. 
   * @return selectVnfDeployableModuleData
   **/
  @Schema(description = "Specify the data needed for selecting deployable modules of a VNF instance. This parameter shall be present only if updateType= SELECT_VNF_DEPL_MODULES. ")
      @Valid
    public List<SelectVnfDeployableModuleData> getSelectVnfDeployableModuleData() {
    return selectVnfDeployableModuleData;
  }

  public void setSelectVnfDeployableModuleData(List<SelectVnfDeployableModuleData> selectVnfDeployableModuleData) {
    this.selectVnfDeployableModuleData = selectVnfDeployableModuleData;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.updateType, updateNsRequest.updateType) &&
        ...
        Objects.equals(this.createDataFlowMirroring, updateNsRequest.createDataFlowMirroring) &&
        Objects.equals(this.deleteDataFlowMirroringId, updateNsRequest.deleteDataFlowMirroringId) &&
        Objects.equals(this.updateDataFlowMirroring, updateNsRequest.updateDataFlowMirroring) &&
        Objects.equals(this.selectVnfDeployableModuleData, updateNsRequest.selectVnfDeployableModuleData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateType, addVnfIstance, removeVnfInstanceId, instantiateVnfData, terminateVnfData, changeVnfFlavourData, operateVnfData, modifyVnfInfoData, changeExtVnfConnectivityData, changeVnfPackageData, addSap, removeSapId, addNestedNsData, removeNestedNsId, assocNewNsdVersionData, moveVnfInstanceData, addVnffg, removeVnffgId, updateVnffg, changeNsFlavourData, addPnfData, modifyPnfData, removePnfId, modifyWanConnectionInfoData, updateTime, createSnapshotData, revertVnfToSnapshotData, deleteVnfSnapshotData, addNsVirtualLinkData, deleteNsVirtualLinkId, feasibilityCheckReserve, createDataFlowMirroring, deleteDataFlowMirroringId, updateDataFlowMirroring, selectVnfDeployableModuleData);
  }
  ...
  public String toString() {
    ...
    sb.append("    createDataFlowMirroring: ").append(toIndentedString(createDataFlowMirroring)).append("\n");
    sb.append("    deleteDataFlowMirroringId: ").append(toIndentedString(deleteDataFlowMirroringId)).append("\n");
    sb.append("    updateDataFlowMirroring: ").append(toIndentedString(updateDataFlowMirroring)).append("\n");
    sb.append("    selectVnfDeployableModuleData: ").append(toIndentedString(selectVnfDeployableModuleData)).append("\n");
    sb.append("}");
    return sb.toString();
  }
