 ...
 * connectivity of the VNF instance * Selection of deployable modules of the VNF
 * instance * Termination of the VNF instance * Modification of VNF instance
 * information and/or VNF configurable properties through the
 * \&quot;PATCH\&quot; method on the \&quot;Individual VNF instance\&quot;
 * resource. If this is the initial notification about the start of a VNF LCM
 ...
 * arrive in any order at the NFVO, and the NFVO shall be able to handle such a
 * situation. If this is a notification about a final or intermediate result
 * state of a VNF LCM operation occurrence, the notification shall be sent after
 * all related actions of the LCM operation that led to this state have been
 * executed. The new state shall be set in the \&quot;Individual VNF LCM
 * operation occurrence\&quot; resource before the notification about the state
 * change is sent. * NOTE 1: Shall be present if the
...
public class VnfLcmOperationOccurrenceNotification {
	...
	@JsonProperty("affectedCertificates")
	@Valid
	private List<AffectedCertificate> affectedCertificates = null;
	...
	public VnfLcmOperationOccurrenceNotification affectedCertificates(final List<AffectedCertificate> affectedCertificates) {
		this.affectedCertificates = affectedCertificates;
		return this;
	}

	public VnfLcmOperationOccurrenceNotification addAffectedCertificatesItem(final AffectedCertificate affectedCertificatesItem) {
		if (this.affectedCertificates == null) {
			this.affectedCertificates = new ArrayList<>();
		}
		this.affectedCertificates.add(affectedCertificatesItem);
		return this;
	}

	/**
	 * Information about certificate content that were affected during the execution
	 * of the lifecycle management operation, if this notification represents the
	 * result of a lifecycle management operation occurrence. Shall be present when
	 * using delegation mode, otherwise shall be absent. This attribute shall be
	 * supported when delegation mode in certificate management is applicable.
	 *
	 * @return affectedCertificates
	 **/
	@Schema(description = "Information about certificate content that were affected during the execution of the lifecycle management operation, if this notification represents the result of a lifecycle management operation occurrence. Shall be present when using delegation mode, otherwise shall be absent. This attribute shall be supported when delegation mode in certificate management is applicable. ")
	@Valid
	public List<AffectedCertificate> getAffectedCertificates() {
		return affectedCertificates;
	}

	public void setAffectedCertificates(final List<AffectedCertificate> affectedCertificates) {
		this.affectedCertificates = affectedCertificates;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.id, vnfLcmOperationOccurrenceNotification.id) &&
				...
				Objects.equals(this.affectedCertificates, vnfLcmOperationOccurrenceNotification.affectedCertificates) &&
	...
	public String toString() {
		...
		sb.append("    affectedCertificates: ").append(toIndentedString(affectedCertificates)).append("\n");
