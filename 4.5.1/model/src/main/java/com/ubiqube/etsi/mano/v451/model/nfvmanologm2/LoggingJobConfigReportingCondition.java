...
/**
 * Specifies the condition under which the producer will report to the consumer
 * about the compiled log data.
 */
...
public class LoggingJobConfigReportingCondition {
	 ...
	 * REPORTING_ON_COMPILATION: the producer shall notify the consumer once the
	 * compilation of the collected logging data into a file is completed and a new
	 * log report is available. - NO_REPORTING: no reporting is requested (the
	 * consumer can query the logging jobs to know about the availability of new log
	 * reports).
	 */
	...
	public LoggingJobConfigReportingCondition reportingType(final ReportingTypeEnum reportingType) {
	...
	public void setReportingType(final ReportingTypeEnum reportingType) {
		this.reportingType = reportingType;
	}

	public LoggingJobConfigReportingCondition minimumReportingPeriod(final Integer minimumReportingPeriod) {
		this.minimumReportingPeriod = minimumReportingPeriod;
		return this;
	}

	/**
	 * Specifies the minimum periodicity at which the producer will report to the
	 * consumer about the collected log information, in seconds. See note 1.
	 *
	...
	public void setMinimumReportingPeriod(final Integer minimumReportingPeriod) {
		this.minimumReportingPeriod = minimumReportingPeriod;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		final LoggingJobConfigReportingCondition loggingJobConfigReportingCondition = (LoggingJobConfigReportingCondition) o;
