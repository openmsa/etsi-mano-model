...
public interface NsInstance451Mapping {
	...
	com.ubiqube.etsi.mano.dao.mano.VnfMonitoringParameter map(com.ubiqube.etsi.mano.v451.model.em.vnflcm.MonitoringParameter o);
	...
	@Mapping(target = "audit", ignore = true)
	VnfMonitoringParameter map(com.ubiqube.etsi.mano.v451.model.nfvo.nslcm.VnfMonitoringParameter o);
