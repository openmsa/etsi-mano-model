...
public class ChangeVnfFlavourRequest {
	...
	public ChangeVnfFlavourRequest selectedDeployableModule(final List<String> selectedDeployableModule) {
		this.selectedDeployableModule = selectedDeployableModule;
		return this;
	}

	public ChangeVnfFlavourRequest addSelectedDeployableModuleItem(final String selectedDeployableModuleItem) {
	...
	public ChangeVnfFlavourRequest certificateConfigurationData(final CertificateConfigurationData certificateConfigurationData) {
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.newFlavourId, changeVnfFlavourRequest.newFlavourId) &&
				...
				Objects.equals(this.selectedDeployableModule, changeVnfFlavourRequest.selectedDeployableModule) &&
				Objects.equals(this.certificateConfigurationData, changeVnfFlavourRequest.certificateConfigurationData);
	}

	@Override
	public int hashCode() {
		return Objects.hash(newFlavourId, instantiationLevelId, targetScaleLevelInfo, extVirtualLinks, extManagedVirtualLinks, additionalParams, extensions, vnfConfigurableProperties, selectedDeployableModule, certificateConfigurationData);
	}
