...
public class VnfPkgInfo {
	 ...
	 * VNFD of the on-boarded VNF package. See note 4. It shall be present after the
	 * VNF package content has been on-boarded and absent otherwise.
	 *
	 * @return vnfmInfo
	 **/
	@Schema(description = "Specifies VNFMs compatible with the VNF. This information is copied from the VNFD of the on-boarded VNF package. See note 4. It shall be present after the VNF package content has been on-boarded and absent otherwise. ")
