...
public class VnfcResourceInfoVnfcCpInfo {
	...
	public VnfcResourceInfoVnfcCpInfo certificateContentId(final String certificateContentId) {
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.id, vnfcResourceInfoVnfcCpInfo.id) &&
				...
				Objects.equals(this.certificateContentId, vnfcResourceInfoVnfcCpInfo.certificateContentId) &&
				Objects.equals(this.metadata, vnfcResourceInfoVnfcCpInfo.metadata);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, cpdId, vnfExtCpId, cpProtocolInfo, vnfLinkPortId, parentCpId, netAttDefResourceId, certificateContentId, metadata);
	}
