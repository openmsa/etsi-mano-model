 ...
 * whose addition/update/deletion was granted. It enables also referencing to a
 * PaaS Service request definition which has been granted.
 */
@Schema(description = "This type contains information about a Compute, storage or network resource whose addition/update/deletion was granted. It enables also referencing to a PaaS Service request definition which has been granted. ")
@Validated
