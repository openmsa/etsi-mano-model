 ...
 * one in the associated VNF Profile if no \&quot;overridingVnfdId\&quot; is
 * provided in the interface as part of \&quot;vnfInstanceData\&quot;, or the
 * \&quot;overridingVnfdId\&quot; provided in the interface if it is provided.
 * NOTE 2: The NS DF of each nested NS shall be one of the allowed flavours in
 * the associated NSD (as referenced in the nestedNsd attribute of the NSD of
 * the NS to be instantiated). NOTE 3: The NSD of each referenced NSs (i.e. each
 * nestedInstanceId) shall match the one of the nested NSD in the composite NSD
 * if no \&quot;overridingNsdId\&quot; is provided in the interface as part of
 * NestedNsInstanceData, or the \&quot;overridingNsdId\&quot; provided in the
 ...
 * instantiation may be specified in either \&quot;nsInstantiationLevelId\&quot;
 * or \&quot;targetNsScaleLevelInfo\&quot;, but not both. If none of the two
 * parameters \&quot;nsInstantiationLevelId\&quot; or
 * \&quot;targetNsScaleLevelInfo\&quot; are present, the default NS
 * instantiation level as declared in the NSD shall be used. NOTE 6: If
 * \&quot;targetNsScaleLevelInfo\&quot; is specified, information provided in
 * \&quot;targetNsScaleLevelInfo\&quot; shall be used to calculate the number of
 * instances of the VNFs/nested NSs referred in the NSD. For VNFs or nested NSs
 * that are not scalable based on \&quot;targetNsScaleLevelInfo\&quot;, the
 * default NS instantiation level as declared in the NSD shall be used to
 * calculate the number of instances those VNFs/nested NSs. NOTE 7: When
 * \&quot;feasibilityCheckReserve\&quot; is set to FEASIBILITY_CHECK_ONLY, the
 * \&quot;startTime\&quot; attribute shall be ignored. NOTE 8: When
 * \&quot;feasibilityCheckReserve\&quot; is set to NO_FEASIBILITY_CHECK, the
 * feasibility checking procedure is not performed. Resources might be reserved
 * as triggered by means outside the present operation request (e.g.,
 ...
 * \&quot;feasibilityCheckReserve\&quot; is set to FEASIBILITY_CHECK_ONLY, only
 * feasibility checking procedure is performed for the operation, no resources
 * are reserved. NOTE 10: When \&quot;feasibilityCheckReserve\&quot; is set to
