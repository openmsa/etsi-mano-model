...
/**
 * Location and address information of the compiled log file. The consumer can
 * use this information to obtain the compiled log file.
 */
...
public class LogReportFileLocationInfo {
	/**
	 * Protocol over which the compiled log file can be retrieved. Permitted values:
	 * - HTTPS: transmission over HTTP Secure (HTTPS). - SFTP: transmission over SSH
	 * file transfer protocol (SFTP). - SCP: transmission over secure copy protocol
	 * (SCP). - FTPS: transmission over file transfer protocol secure (FTPS), as
	 * specified in IETF RFC 2228, using explicit mode as specified in IETF RFC
	 * 4217. If FTPS is supported, \"private\" protection level shall be used. HTTPS
	 * shall be supported, and other protocols may be supported.
	 */
	...
	public LogReportFileLocationInfo protocol(final ProtocolEnum protocol) {
	...
	public LogReportFileLocationInfo fileEndpoint(final String fileEndpoint) {
		this.fileEndpoint = fileEndpoint;
		return this;
	}

	/**
	 * The host name (or IP address), optionally a port number (if the host with the
	 * compile log file uses a non-standard port number as per the supported
	 * transmission protocol), a valid file directory path, and the file name of the
	 * compiled log file, or a valid URL.
	 *
	 * @return fileEndpoint
	 **/
	...
	public void setFileEndpoint(final String fileEndpoint) {
		this.fileEndpoint = fileEndpoint;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		final LogReportFileLocationInfo logReportFileLocationInfo = (LogReportFileLocationInfo) o;
