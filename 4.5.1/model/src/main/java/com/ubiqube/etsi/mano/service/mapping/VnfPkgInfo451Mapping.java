...
public interface VnfPkgInfo451Mapping extends StringToUri451Mapping {
	...
	Checksum map(com.ubiqube.etsi.mano.nfvo.v451.model.vnfsnapshotpkgm.Checksum o);
	...
	@Mapping(target = "sha256", ignore = true)
	@Mapping(target = "sha512", ignore = true)
	PkgChecksum mapToPkgChecksum(com.ubiqube.etsi.mano.nfvo.v451.model.vnfsnapshotpkgm.Checksum o);
