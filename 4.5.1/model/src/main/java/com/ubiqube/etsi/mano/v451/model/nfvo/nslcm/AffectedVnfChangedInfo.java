...
import com.ubiqube.etsi.mano.v451.model.em.vnflcm.CertificateInfo;
import com.ubiqube.etsi.mano.v451.model.em.vnflcm.ExtVirtualLinkInfo;
import com.ubiqube.etsi.mano.v451.model.em.vnflcm.ModificationsTriggeredByVnfPkgChange;
 ...
 * configurable properties, and certificate content if applicable. When the
 * \&quot;changedInfo\&quot; attribute is present, either the
 * \&quot;changedVnfInfo\&quot; attribute or the
 * \&quot;changedExtConnectivity\&quot; attribute or both shall be present.
 */
@Schema(description = "Information about the changed VNF instance information, including VNF configurable properties, and certificate content if applicable. When the \"changedInfo\" attribute is present,  either the \"changedVnfInfo\" attribute or the \"changedExtConnectivity\" attribute or both shall be present. ")
@Validated
...
public class AffectedVnfChangedInfo {
	...
	@JsonProperty("changedCertificateInfo")
	@Valid
	private List<CertificateInfo> changedCertificateInfo = null;
	...
	public AffectedVnfChangedInfo changedCertificateInfo(final List<CertificateInfo> changedCertificateInfo) {
		this.changedCertificateInfo = changedCertificateInfo;
		return this;
	}

	public AffectedVnfChangedInfo addChangedCertificateInfoItem(final CertificateInfo changedCertificateInfoItem) {
		if (this.changedCertificateInfo == null) {
			this.changedCertificateInfo = new ArrayList<>();
		}
		this.changedCertificateInfo.add(changedCertificateInfoItem);
		return this;
	}

	/**
	 * Information about changed certificate, if applicable. See note
	 *
	 * @return changedCertificateInfo
	 **/
	@Schema(description = "Information about changed certificate, if applicable. See note ")
	@Valid
	public List<CertificateInfo> getChangedCertificateInfo() {
		return changedCertificateInfo;
	}

	public void setChangedCertificateInfo(final List<CertificateInfo> changedCertificateInfo) {
		this.changedCertificateInfo = changedCertificateInfo;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.changedVnfInfo, affectedVnfChangedInfo.changedVnfInfo) &&
				...
				Objects.equals(this.changedCertificateInfo, affectedVnfChangedInfo.changedCertificateInfo);
	}

	@Override
	public int hashCode() {
		return Objects.hash(changedVnfInfo, changedExtConnectivity, modificationsTriggeredByVnfPkgChange, changedCertificateInfo);
	}
	...
	public String toString() {
		...
		sb.append("    changedCertificateInfo: ").append(toIndentedString(changedCertificateInfo)).append("\n");
		sb.append("}");
		return sb.toString();
	}
