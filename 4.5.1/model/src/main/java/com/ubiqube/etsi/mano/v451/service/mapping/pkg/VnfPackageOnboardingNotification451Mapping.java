...
public interface VnfPackageOnboardingNotification451Mapping {
	...
	VnfPackageChangeNotification map(com.ubiqube.etsi.mano.v451.model.nfvo.vnf.@Valid VnfPackageChangeNotification body);

	@Mapping(target = "nfvoId", ignore = true)
	@Mapping(target = "version", ignore = true)
	@Mapping(target = "id", ignore = true)
	VnfPackageOnboardingNotification map(com.ubiqube.etsi.mano.v451.model.nfvo.vnf.@Valid VnfPackageOnboardingNotification body);
