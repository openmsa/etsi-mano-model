 ...
 */
package com.ubiqube.etsi.mano.vnfm.v451.model.grant;
...
public class GrantRequest implements AnyOfGrantRequest {
	...
	public GrantRequest selectedDeployableModule(final List<String> selectedDeployableModule) {
		this.selectedDeployableModule = selectedDeployableModule;
		return this;
	}

	public GrantRequest addSelectedDeployableModuleItem(final String selectedDeployableModuleItem) {
	...
	/**
	 * References a selected deployable module. Resources related to VDUs that
	 * belong to not selected deployable modules shall not be considered in the
	 * granting This attribute shall only be used for the instantiate VNF request.
	 * See note 10.
	 *
	 * @return selectedDeployableModule
	 **/
	@Schema(description = "References a selected deployable module. Resources related to VDUs that belong to not selected deployable modules shall not be considered in the granting This attribute shall only be used for the instantiate VNF request. See note 10. ")
	 ...
	 * resource. See notes 2, 9 and 10.
	 *
	 * @return addResources
	 **/
	@Schema(description = "List of resource definitions in the VNFD for resources to be added by the LCM operation  which is related to this grant request, with one entry per resource. See notes 2, 9 and 10. ")
	@Valid
	 ...
	 * grant request, with one entry per resource. See notes 3 and 9.
	 *
	 * @return tempResources
	 **/
	@Schema(description = "List of resource definitions in the VNFD for resources to be temporarily instantiated during  the runtime of the LCM operation which is related to this grant request, with one entry per  resource. See notes 3 and 9. ")
	@Valid
	 ...
	 * which is related to this grant request, with one entry per resource. See note
	 * 9.
	 *
	 * @return removeResources
	 **/
	@Schema(description = "Provides the definitions of resources to be removed by the LCM operation which is related to this grant request, with one entry per resource. See note 9. ")
	@Valid
	 ...
	 **/
	@Schema(description = "Provides the definitions of resources to be modified by the LCM operation which is related to this grant request, with one entry per resource. See note 9. ")
	@Valid
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.vnfInstanceId, grantRequest.vnfInstanceId) &&
				...
				Objects.equals(this.selectedDeployableModule, grantRequest.selectedDeployableModule) &&
