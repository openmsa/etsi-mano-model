...
import com.ubiqube.etsi.mano.em.v451.model.vnflcm.CpProtocolInfo;
import com.ubiqube.etsi.mano.em.v451.model.vnflcm.ExtLinkPortInfo;
...
import com.ubiqube.etsi.mano.em.v451.model.vnflcm.IpOverEthernetAddressInfo;
import com.ubiqube.etsi.mano.em.v451.model.vnflcm.IpOverEthernetAddressInfoIpAddresses;
import com.ubiqube.etsi.mano.em.v451.model.vnflcm.VirtualCpInfo;
import com.ubiqube.etsi.mano.em.v451.model.vnflcm.VnfExtCpInfo;
...
public interface VnfInstance451Mapping extends VimConnectionInfo451Mapping, Connectivity451Mapping {
	...
	com.ubiqube.etsi.mano.em.v451.model.vnflcm.VnfInstance map(VnfInstance vnfInst);
	...
	VnfInstance map(com.ubiqube.etsi.mano.em.v451.model.vnflcm.VnfInstance pkg);
	...
	@Mapping(target = "id", ignore = true)
	McioInfo map(com.ubiqube.etsi.mano.em.v451.model.vnflcm.McioInfo mi);

	com.ubiqube.etsi.mano.em.v451.model.vnflcm.McioInfo map(McioInfo mi);

	@Mapping(target = "id", ignore = true)
	NetAttDefResourceInfo map(com.ubiqube.etsi.mano.em.v451.model.vnflcm.NetAttDefResourceInfo nadr);

	@Mapping(target = "id", ignore = true)
	ScaleInfo map(com.ubiqube.etsi.mano.em.v451.model.vnflcm.ScaleInfo si);

	@Mapping(target = "id", ignore = true)
	VipCpInfo map(com.ubiqube.etsi.mano.em.v451.model.vnflcm.VipCpInfo vc);

	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "zoneId", ignore = true)
	VirtualStorageResourceInfo map(com.ubiqube.etsi.mano.em.v451.model.vnflcm.VirtualStorageResourceInfo virtualStorageResourceInfo);

	com.ubiqube.etsi.mano.em.v451.model.vnflcm.VirtualStorageResourceInfo map(VirtualStorageResourceInfo vsri);
	...
	@Mapping(target = "id", ignore = true)
	AdditionalServiceInfo map(com.ubiqube.etsi.mano.em.v451.model.vnflcm.AdditionalServiceInfo asi);

	@Mapping(target = "id", ignore = true)
	ServicePortInfo map(com.ubiqube.etsi.mano.em.v451.model.vnflcm.ServicePortInfo spi);
	...
	VirtualCpAddressInfo map(com.ubiqube.etsi.mano.em.v451.model.vnflcm.VirtualCpAddressInfo vcp);

	@Mapping(target = "addressPoolName", ignore = true)
	com.ubiqube.etsi.mano.em.v451.model.vnflcm.VirtualCpAddressInfo mapToVirtualCpAddressInfo(VirtualCpAddressInfo vcp);
