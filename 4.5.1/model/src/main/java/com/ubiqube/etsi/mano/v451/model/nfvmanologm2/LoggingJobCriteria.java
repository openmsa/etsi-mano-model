...
/**
 * This type represents collection criteria for logging jobs. * NOTE: The value
 * of the loggingType has dependency on the object that is requested to be
 * logged (refer to the CreateLoggingJobRequest): a) the logging of messages is
 * only applicable to ManoServiceInterface and ConsumedManoInterface objects.
 */
...
public class LoggingJobCriteria {
	 ...
	 * Permitted values: - MESSAGES: logged NFV-MANO service interface messages. -
	 * SERVICES: logged messages about processes pertaining to NFV-MANO services. -
	 * SYSTEM: logged messages about the NFV-MANO functional entity’s system enabled
	 * by the provider. See note.
	 */
	...
	public LoggingJobCriteria loggingType(final LoggingTypeEnum loggingType) {
	...
	public void setLoggingType(final LoggingTypeEnum loggingType) {
		this.loggingType = loggingType;
	}

	public LoggingJobCriteria messagesLogDetail(final LoggingJobMessagesCriteria messagesLogDetail) {
	...
	public void setMessagesLogDetail(final LoggingJobMessagesCriteria messagesLogDetail) {
		this.messagesLogDetail = messagesLogDetail;
	}

	public LoggingJobCriteria servicesLogDetail(final LoggingJobServicesCriteria servicesLogDetail) {
	...
	public void setServicesLogDetail(final LoggingJobServicesCriteria servicesLogDetail) {
		this.servicesLogDetail = servicesLogDetail;
	}

	public LoggingJobCriteria systemLogDetail(final LoggingJobSystemCriteria systemLogDetail) {
	...
	public void setSystemLogDetail(final LoggingJobSystemCriteria systemLogDetail) {
		this.systemLogDetail = systemLogDetail;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		final LoggingJobCriteria loggingJobCriteria = (LoggingJobCriteria) o;
