...
@RestController
public class VnfIndicatorValueChangeNotification361Sol003Controller implements VnfIndicatorValueChangeNotification361Sol003Api {
	private final VnfIndicatorNotificationFrontController fc;
	private final PmJobNotification361Mapping mapper;

	public VnfIndicatorValueChangeNotification361Sol003Controller(final VnfIndicatorNotificationFrontController fc, final PmJobNotification361Mapping mapper) {
		this.fc = fc;
		this.mapper = mapper;
	}
