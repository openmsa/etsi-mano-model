...
public class AlarmListRebuiltNotification361Sol003Controller implements AlarmListRebuiltNotification361Sol003Api {
	...
	private final AlarmsNotification361Mapping mapper;

	public AlarmListRebuiltNotification361Sol003Controller(final VnffmNotificationFrontController fc, final AlarmsNotification361Mapping mapper) {
		this.fc = fc;
		this.mapper = mapper;
	}
