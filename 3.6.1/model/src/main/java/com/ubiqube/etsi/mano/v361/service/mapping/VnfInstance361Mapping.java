...
public interface VnfInstance361Mapping extends VimConnectionInfo361Mapping, Connectivity361Mapping, VimResource361Mapping {
...
//	@Mapping(target = "id", ignore = true)
	VnfInstance map(com.ubiqube.etsi.mano.v361.model.em.vnflcm.VnfInstance pkg);
	...
	com.ubiqube.etsi.mano.v361.model.em.vnflcm.ScaleInfo map(ScaleInfo o);
	...
	@Mapping(target = "id", ignore = true)
	VipCpInfo map(com.ubiqube.etsi.mano.v361.model.em.vnflcm.VipCpInfo vc);

	@Mapping(target = "audit", ignore = true)
	@Mapping(target = "zoneId", ignore = true)
	VirtualStorageResourceInfo map(com.ubiqube.etsi.mano.v361.model.em.vnflcm.VirtualStorageResourceInfo virtualStorageResourceInfo);

	com.ubiqube.etsi.mano.v361.model.em.vnflcm.VirtualStorageResourceInfo map(VirtualStorageResourceInfo vsri);
