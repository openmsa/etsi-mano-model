...
public interface PmJobNotification361Mapping extends DateTimeMapping {
	...
	PerformanceInformationAvailableNotification map(com.ubiqube.etsi.mano.v361.model.vnfm.vnfpm.@Valid PerformanceInformationAvailableNotification body);

	@Mapping(target = "nfvoId", ignore = true)
	@Mapping(target = "subscriptionId", ignore = true)
	@Mapping(target = "performanceValue", ignore = true)
	ThresholdCrossedNotification map(com.ubiqube.etsi.mano.v361.model.vnfm.vnfpm.@Valid ThresholdCrossedNotification body);
