...
import com.ubiqube.etsi.mano.v361.model.nfvo.vnf.VnfPackageArtifactInfo;
...
public interface VnfPkgInfo361Mapping extends StringToUriMapping {
	...
	@Mapping(target = "sha256", ignore = true)
	@Mapping(target = "sha512", ignore = true)
	PkgChecksum mapToPkgChecksum(com.ubiqube.etsi.mano.v361.model.nfvo.vnfsnapshotpkgm.Checksum o);
