...
import com.ubiqube.etsi.mano.v361.service.mapping.subscription.BaseSubscription361Mapping;
...
public interface PmJob361Mapping extends BaseSubscription361Mapping, DateTimeMapping {
	...
	PmJob map(com.ubiqube.etsi.mano.v361.model.em.vnfpm.PmJob o);

	@Mapping(target = "id", ignore = true)
	PmReport map(PmJobReports o);

	@Mapping(target = "links", ignore = true)
	com.ubiqube.etsi.mano.v361.model.em.vnfpm.PmJob map(PmJob o);
	...
	com.ubiqube.etsi.mano.v361.model.em.vnfpm.PerformanceReport map(PerformanceReport x);
