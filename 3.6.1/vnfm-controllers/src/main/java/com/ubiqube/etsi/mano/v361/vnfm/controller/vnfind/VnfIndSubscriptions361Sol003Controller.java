...
public class VnfIndSubscriptions361Sol003Controller implements VnfIndSubscriptions361Sol003Api, SubscriptionLinkable361Vnfm {
	...
	private final VnfIndicatorSubscription361Mapping mapper;

	public VnfIndSubscriptions361Sol003Controller(final SubscriptionFrontController subscriptionService, final VnfIndicatorSubscription361Mapping mapper) {
	...
	public ResponseEntity<List<VnfIndicatorSubscription>> subscriptionsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return subscriptionService.search(requestParams, x -> mapper.map(x, VnfIndicatorNotificationsFilter.class), VnfIndSubscriptions361Sol003Controller::makeLinks, ApiVersionType.SOL003_VNFIND);
	}
	...
	public ResponseEntity<VnfIndicatorSubscription> subscriptionsPost(@Valid final VnfIndicatorSubscriptionRequest body) {
		...
		return subscriptionService.create(req, x -> mapper.map(x, VnfIndicatorNotificationsFilter.class), VnfIndSubscriptions361Sol003Api.class, VnfIndSubscriptions361Sol003Controller::makeLinks, VnfIndSubscriptions361Sol003Controller::makeSelf, ApiVersionType.SOL003_VNFIND);
	}
	...
	public ResponseEntity<VnfIndicatorSubscription> indicatorsSubscriptionsSubscriptionIdGet(final String subscriptionId) {
		return subscriptionService.findById(subscriptionId, x -> mapper.map(x, VnfIndicatorNotificationsFilter.class), VnfIndSubscriptions361Sol003Controller::makeLinks, ApiVersionType.SOL003_VNFIND);
	}
