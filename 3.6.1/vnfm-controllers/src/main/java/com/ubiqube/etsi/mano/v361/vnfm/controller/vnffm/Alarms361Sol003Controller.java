...
public class Alarms361Sol003Controller implements Alarms361Sol003Api {
	...
	public Alarms361Sol003Controller(final AlarmFrontController alarmFrontController, final Alarm361Mapping mapper) {
	...
	public ResponseEntity<Alarm> alarmsAlarmIdGet(final String alarmId) {
		return alarmFrontController.findById(alarmId, x -> mapper.map(x), Alarms361Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<String> alarmsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return alarmFrontController.search(requestParams, x -> mapper.map(x), Alarms361Sol003Controller::makeLinks, Alarm.class);
	}
